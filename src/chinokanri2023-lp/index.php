						...
						<div data-aos="fade-right" class="col-sm-6">
							<div class="article">
								...
								<div class="article__item">
									<h3>担当者を2名配置し、<br>
									迅速で適切なサービスの提供</h3>
									<p>担当者を２名置くことにより相互チェック、業務遅延や不正行為の防止。管理不均一を無くし、平準化された円滑な管理サービスを提供。</p>
									<p>担当者と管理組合様と良好な関係を継続し二人三脚によって、一般的な管理会社より高いレスポンスを実現していきます。そしてシームレスな人員配置変更もできるので、お客様の多様なご要望にもお応えします。</p>
									<p></p>
								</div>
							</div>
						</div>	
						<div data-aos="fade-right" class="col-sm-6">
							<div class="article">
								...
								<div class="article__item">
									<h3>管理業務にDXを活用し、<br>
									円滑で効率的な運営を実現</h3>
									<p>当社は管理業務にiPadなどの機器を標準的に配置しています。グループチャットやWEB会議システムによるコミュニケーションの高速化やオンライン予約システムを採用した施設予約の導入などを促進し、お客様の利便性を高めます。標準で総会オンライン投票や電子署名システムを採用。ご要望に応じて管理アプリのご提案も可能です。</p>
									<p></p>
								</div>
							</div>
						</div>	
						...
						<div data-aos="fade-right" class="col-sm-6">
							<div class="article">
								...
								<div class="article__item">
									<h3>お客様の立場で<br>
									良質な工事をサポート</h3>
									<p>大規模修繕工事など、専門的知識や経験が必要となる工事について、管理組合様の立場にたって、品質面・金額面で最適な工事が実現できるようサポートいたします。</p>
								</div>
							</div>
						</div>	
						<div data-aos="fade-right" class="col-sm-6">
							<div class="article">
								...
								<div class="article__item">
									<h3>お客様や建物の状況に合わせた管理メニュー、運営のご提案</h3>
									<p>お客様のご要望をヒアリングのうえ、希望に沿った管理計画を立案・サポートを行います。</p>
								</div>
							</div>
						</div>
						<div data-aos="fade-right" class="col-sm-6">
							<div class="article">
								...
								<div class="article__item">
									<h3>24時間365日対応の<br>
										緊急受付窓口による安心対応</h3>
									<p>夜間休日などのトラブル発生時にコールセンターが受付し、迅速に対応します。</p>
								</div>
							</div>
						</div>	
					</div>
					...
					<div class="address__table">
						<table>
							...
							<tr>
								...
								<td>
									<a href="https://www.chinokanri.co.jp">https://www.chinokanri.co.jp/</a>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									9:00～18:00<span class="d-block d-md-inline">（定休日：水・日・祝日）</span>
								</td>
							</tr>
						</table>
					</div>
