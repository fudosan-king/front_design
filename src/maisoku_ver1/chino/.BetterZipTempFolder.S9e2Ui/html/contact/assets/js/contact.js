            ...
            if (typeof($(this)) !== 'undefined' && $(this).prop('type') == 'radio') {
                ...
                if (typeof(elem.val()) === 'undefined' || elem.val() == "" || elem.val() == "null") {
                    ...
                    if (elem.prop('name') != 'first-impression-etc') {
                        ...
                        if (elem.prop('name') == 'sei' || elem.prop('name') == 'mei') {

                            $('.require-flag.furi').css('background-color', '#ff0700');
                        }
                        ...
                        if (elem.prop('name') == 'iken') {
                            $('.require-flag.iken').css('background-color', '#ff0700');
                        }
                    }
...
$(document).ready(function() {
    ...
    $('#goConfirm').click(function() {
        ...
        if (invalidCheck()) {
            ...
            var cfrm_furi = $('input[name="sei"]').val() + $('input[name="mei"]').val();
            $('.cfrm_furi').html(cfrm_furi);

            var cfrm_address = $('input[name="post"]').val() + '<br>' +
                $('select[name="pref"]').val() + '<br>' + $('input[name="city"]').val() + '<br>' + $('input[name="aza_ooaza"]').val() + '<br>' +
    ...
    $('#goBack').click(function() {
        $('.form_info.input').fadeIn(function() {
            $('html').scrollTop($('.frm_contact').offset().top);
        });
