! function(n) {
    "use strict";
    var a = {
        initialize: function() { this.event(), this.toggler(), this.dropdown(), this.mobileMenu(), this.sideMenu(), this.navbarSticky(), this.scrollspy() },
        event: function() {},
        toggler: function() {
        ...
        scrollspy: function() {
            var a = n(".bsnav-scrollspy"),
                ...
                i = [];
            if (a.length) {
                a.find("[data-scrollspy]").each(function(a) { i.push(n(this).data("scrollspy")) });
                ...
                n(window).scroll(function() { e() }), a.find("[data-scrollspy]").click(function(i) {
