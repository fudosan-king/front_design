...
<head>
	...
	<title>C-type 間取り | 【公式】プレシス葛西プロスタイル | 新築分譲マンション</title>
	...
	<meta property="og:title" content="C-type 間取り | 【公式】プレシス葛西プロスタイル | 新築分譲マンション">
...
<body id="top" class="reserv mincho">
	...
	<div id="room02" class="plan_modal_wrapper">
		<div class="u_textCenter plan_modal_box">
			<p class="ttl"><img src="./images/plan/ttl_c.png" alt="C-type"></p>
		...
		-->
			...
			<p class="retrn"><a href="plan.html"><img src="images/plan/btn_return.jpg" alt="一覧ページに戻る"></a></p>
		</div>
