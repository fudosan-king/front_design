...
<head>
	...
	<title>A-type 間取り | 【公式】プレシス葛西プロスタイル | 新築分譲マンション</title>
	...
	<meta property="og:title" content="A-type 間取り | 【公式】プレシス葛西プロスタイル | 新築分譲マンション">
...
<body id="top" class="reserv mincho">
	...
	<div id="room02" class="plan_modal_wrapper">
		<div class="u_textCenter plan_modal_box">
			<p class="ttl"><img src="./images/plan/ttl_a.png" alt="A-type"></p>
