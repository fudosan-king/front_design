...
<head>
	...
	<title>間取り | 【公式】プレシス葛西プロスタイル | 新築分譲マンション</title>
	...
	<meta property="og:title" content="間取り | 【公式】プレシス葛西プロスタイル | 新築分譲マンション">
	<meta property="og:type" content="article">
	<meta property="og:url" content="/plan.html">
...
<body id="top" class="reserv mincho">
	...
	<section class="plan">
		<div class="c_mv">
			<h2 class="c_mv_title">PLAN<span class="c_mv_title_small">間取り</span></h2>
		</div>
		...
		-->
			...
			<div style="width: 80%; max-width: 350px; margin: 50px auto 20px;">
				<img src="images/casbee.png" alt="CASBEE" width="100%">
			</div>
		</div>
