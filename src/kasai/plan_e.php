...
<head>
	...
	<title>E-type 間取り | 【公式】プレシス葛西プロスタイル | 新築分譲マンション</title>
	...
	<meta property="og:title" content="E-type 間取り | 【公式】プレシス葛西プロスタイル | 新築分譲マンション">
...
<body id="top" class="reserv mincho">
	...
	<div id="room02" class="plan_modal_wrapper">
		<div class="u_textCenter plan_modal_box">
			<p class="ttl"><img src="./images/plan/ttl_e.png" alt="E-type"></p>
