				...
				<div class="c_tab_box_nomal l_container">
					<div class="c_tab_box_cont c_tab_box_nomal">
							...
							<div>
								...
								<div class="clearfix str01_in">
									...
									<div>
										...
										<p>床スラブ厚<span>約200〜250mm</span></p>
										<p>外壁厚<span>約150mm（一部除く）</span></p>
										<p>戸境壁厚<span>約180〜220mm</span></p>
									</div>
								</div>
							</div>
						...
						<div class="c_float_box_3col">
							...
							<div class="c_float_item_3col">
								<p style="position: relative;"><img src="./images/structure/img14.jpg" alt="img"></p>
								<p class="txt" style="margin-top: 10px;"><small>※詳しくは係員にお尋ねください。</small></p>
							</div>
							<div class="c_float_item_3col">
								<p style="position: relative;"><img src="./images/structure/img15.jpg" alt="img"></p>
						...
						<div class="tebra_wrap">
							...
							<div class="clearfix tebra03">
								...
								<div>
									<p class="tebra_txt02"><img src="images/structure/icon_1.jpg" alt=""><span>エントランス</span></p>
									<div class="clearfix">
										<div><img src="images/structure/img02.jpg" alt=""></div>
										<p class="txt">操作盤の前に立つだけで、オートロックを解除。鍵穴にキーを差し込んだりかざす必要もありません。<small>※作動範囲があります。</small></p>
									</div>
								</div>
								<div>
									<p class="tebra_txt02"><img src="images/structure/icon_2.jpg" alt=""><span>エレベーター前</span></p>
									<div class="clearfix">
										<div><img src="images/structure/img03.jpg" alt=""></div>
								...
								<div>
									...
									<div class="clearfix">
										<div><img src="images/structure/img04.jpg" alt=""></div>
										<p class="txt">玄関には安心のダブルロック、鍵の複製が困難なディンプルキーを採用し、セキュリティを高めています。<small>※有償オプション</small></p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="c_float_box_4col">
							<div class="c_float_item_4col">
								...
								<p class="c_float_text_name">24時間セキュリティシステム</p>
								<p class="txt" style="margin-top: 10px;">住戸内で火災などの異常が発生した場合、住戸内のセキュリティインターホンが警報音を鳴らし、警報表示が点滅、さらに管理室にも警報が届きます。同時に綜合警備保障へ自動通報され、迅速かつ的確に対処。状況に応じて関係各所に通報します。</p>
							</div>
							<div class="c_float_item_4col">
								<p style="position: relative;"><img src="./images/structure/img17.jpg" alt="img"></p>
								<p class="c_float_text_name">カラーモニター付多機能インターフォン</p>
								<p class="txt" style="margin-top: 10px;">各住戸のカラーモニターでエントランスホールにいる来訪者を映像と音声で確認してから解錠できるので安心です。</p>
							</div>
							<div class="c_float_item_4col">
								<p style="position: relative;"><span class="img_cap" style="left: unset; right:0;">参考写真</span><img src="./images/structure/img18.jpg" alt="img"></p>
								<p class="c_float_text_name">監視カメラ設置（リース）</p>
								<p class="txt" style="margin-top: 10px;">共用部分各所に監視カメラを設置。監視機能としてはもちろん、犯罪等の抑止効果も高まります。</p>
							</div>
							<div class="c_float_item_4col">
								<p style="position: relative;"><span class="img_cap" style="left: unset; right:0;">参考写真</span><img src="./images/structure/img19.jpg" alt="img"></p>
								<p class="c_float_text_name">ダブルロック仕様で安心のディンプルキー</p>
				...
				<div class="c_tab_box_cont l_container">
					...
					<div class="c_float_box_3col">
						<div class="c_float_item_3col">
							...
							<p style="position: relative;"><span class="img_cap" style="left: unset; right:0;">image</span><img src="./images/structure/muku04.jpg" alt="img"></p>
							<p class="txt" style="margin-top: 10px;">山や森で育った原木をひき割って作った「無垢材」は、いわゆる自然素材です。アトピーや喘息、シックハウス症候群の原因になる「ホルムアルデヒド」を含む接着剤を使用していないため、安心・安全です。無垢材は住む人の健康を考えるうえで、非常に魅力的な建材です。 </p>
						</div>
						<div class="c_float_item_3col">
							<p class="structure_title" style="margin-bottom:15px">オリジナリティ溢れる無垢材</p>
							<p style="position: relative;"><img src="./images/structure/muku05.jpg" alt="img"></p>
							<p class="txt" style="margin-top: 10px;">オークの天然無垢材の表面には虎斑（とらふ）と呼ばれる独特の縞模様があり、またそのひとつひとつが異なる表情を持ちます。生きた木から取られた無垢材は 一枚一枚がそれぞれに個性を持ち、世界中を探しても同じ物は一つとしてなく、オリジナリティ溢れる材料です。</p>
						</div>
						<div class="c_float_item_3col">
							<p class="structure_title" style="margin-bottom:15px">吸音効果</p>
							<p style="position: relative;"><img src="./images/structure/muku06.jpg" alt="img"></p>
							<p class="txt" style="margin-top: 10px;">無垢材フローリングは高い吸音効果を持っています。木材は多孔質構造のため、高音から低音まで幅広く吸音するので、部屋の生活音、残響音をまろやかに緩和することができ、心地よい空間を作ります。</p>
						</div>
						<div class="c_float_item_3col">
							<p class="structure_title" style="margin-bottom:15px">天然の除加湿器</p>
							<p class="txt" style="margin-top: 10px;">天然の木は、伐採された後も呼吸を続けています。湿気が多いと吸収し、乾燥すると蓄えた湿度を吐き出す調湿効果があります。例えば奈良の正倉院は太い木材を横にして重ねていく校倉造り。1300年近くの時を経た今でも、中の宝物を大切に守り続けているのは、木のもつ優れた調湿作用によって結露やカビも防止でき、空気をきれいにし、快適に保つことが出来るためです。</p>
						</div>
						<div class="c_float_item_3col">
							<p class="structure_title" style="margin-bottom:15px">天然のアロマオイル</p>
							<p class="txt" style="margin-top: 10px;">森林浴をすると、リラックスして心地よくなるのは、樹木が発する芳香成分（フィトンチッド）の働きによるものです。フィトンチッドには、人間の自律神経を安定させる作用があると言われています。 天然無垢材はアロマテラピーのような香りで心も体もリフレッシュでき、ストレスを和らげます。</p>
						</div>
						<div class="c_float_item_3col">
							<p class="structure_title" style="margin-bottom:15px">優れた耐久性</p>
