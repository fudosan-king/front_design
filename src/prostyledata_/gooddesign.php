	      	...
	      	<main>
	      		<section class="section_ryokan">
	      			<div class="container">
	      				<div class="row">
	      					<div class="col-12">
	      						<h1><img src="images/1x/g_type2019_f@2x.png" alt="" class="img-fluid"> <span>受賞</span></h1>
	      						<h2><span class="name">PROSTYLE</span> <span class="hotel">旅館</span> 横浜馬車道</h2>
	      						<div class="box_ryokan_topimg mx-auto text-center">
	      							<img src="images/1x/fasade@2x.png" alt="" class="img-fluid">
	      		...
	      		<section class="section_concetp">
	      				...
	      				<div class="row">
	      					<div class="col-12">
	      						<div class="text-center">
		      						<img src="images/1x/アセット 1@2x.png" alt="" class="img-fluid">
		      						<h2>Concept</h2>
	      			...
	      			<div class="w_big_imgconcept">
		      			<div class="big_imgconcept">
		      				<img src="images/1x/tatami@2x.png" alt="" class="img-fluid">
		      			</div>
		      			<div class="container">
		      				<div class="row">
		      					<div class="col-12">
		      					...
		      					<div class="col-12 col-md-4">
		      						<div class="concept_item">
		      							<a href="#" class="concept_item_img">
		      								...
		      								<img src="images/1x/画像 11@2x.png" alt="" class="img-fluid">
		      							</a>
		      					...
		      					<div class="col-12 col-md-4">
		      						<div class="concept_item">
		      							<a href="#" class="concept_item_img">
		      								...
		      								<img src="images/1x/画像 13@2x.png" alt="" class="img-fluid">
		      							</a>
		      					...
		      					<div class="col-12 col-md-4">
		      						<div class="concept_item">
		      							<a href="#" class="concept_item_img">
		      								...
		      								<img src="images/1x/画像 12@2x.png" alt="" class="img-fluid">
		      							</a>
		      							...
		      							<div class="col-12 col-md-6">
				      						<div class="concept_item">
				      							<a href="#" class="concept_item_img">
				      								...
				      								<img src="images/1x/画像 14@2x.png" alt="" class="img-fluid">
				      							</a>
				      					...
				      					<div class="col-12 col-md-6">
				      						<div class="concept_item">
				      							<a href="#" class="concept_item_img">
				      								...
				      								<img src="images/1x/画像 15@2x.png" alt="" class="img-fluid">
				      							</a>
