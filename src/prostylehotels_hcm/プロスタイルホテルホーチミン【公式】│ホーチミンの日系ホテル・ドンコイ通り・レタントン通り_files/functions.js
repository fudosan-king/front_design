$(function($) {
    ...
    var NavDisplay = $('.menu_controller').data('display');
    if (NavDisplay==true){
        var app = function() {
            var body = void 0;
            var menu = void 0;
    ...
    $window.on("mousewheel DOMMouseScroll", function(event){
        ...
        if($('.swiper_accomodation').length==0){
    ...
    if($('.swiper1').length){
        var swiper1 = new Swiper('.swiper1', {
            ...
            navigation: {
                nextEl: '.swiper-button-afternoontea-next',
                prevEl: '.swiper-button-afternoontea-prev',
            },
            breakpoints: {
                414: {
                    slidesPerView: 1,
    ...
    if($('.swiper2').length){
        var swiper2 = new Swiper('.swiper2', {
            ...
            navigation: {
                nextEl: '.swiper-button-restaurant-next',
                prevEl: '.swiper-button-restaurant-prev',
            },
            breakpoints: {
                414: {
                    slidesPerView: 1,
