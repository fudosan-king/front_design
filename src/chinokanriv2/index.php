                    ...
                    <div class="container">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                                ...
                                <article class="content">
                                    ...
                                    <div class="social text-center">
                                        <div class="fb-page" data-href="https://www.facebook.com/CHINOTATEMONOKANRI/" data-tabs="" data-width="571" data-height="181" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false">
                                            <blockquote cite="https://www.facebook.com/CHINOTATEMONOKANRI/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/CHINOTATEMONOKANRI/">千野建物管理株式会社</a></blockquote>
                                        </div>
                                        <div class="instagram-page">
                                            <a href="https://www.instagram.com/chino_tatemonokanri/" target="_blank">
                                                <img src="https://www.chinokanri.co.jp/assets/img/common/instagram_profile.png" class="img-fluid" alt="Responsive image">
                                            </a>
                                        </div>
                                    </div>
                                </article>
                        ...
                        <section id="access" class="row access">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                                ...
                                <article class="content">
                                    <iframe src="https://www.google.com/maps/d/embed?mid=1fYCtV5et5m5UFxQixA8wjlVjHhgj5aMq&ll=17" width="100%" height="480" class="map"></iframe>
                                </article>
                            </div>
                        </section>
                        ...
                        <section class="row cancellation text-center">
                            <div class="col-12 col-lg-12">
                                <!-- <a class="btn btn_athome" href="https://www.chinokanri.co.jp/kaiyaku" target="_blank">
                                    <h4>自宅にいながらウェブからカンタン！</h4>
                                    <p>オンライン解約申請はこちら</p>
                                </a> -->
                                <a class="btn btn_apply mb-5" href="naiken.php">仲介業者様専用内見依頼フォーム</a>
                            </div>
                        </section>
                    </div>
                </section>
