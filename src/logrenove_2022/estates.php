                                ...
                                <li>
                                    <a href="detail.php">
                                        ...
                                        <div class="box_body">
                                            ...
                                            <h4>東京都渋谷区神宮前 6-25-8
                                                <span>東京メトロ千代田線・副都心線「明治神宮前」駅徒歩3分</span>
                                            </h4>
                                ...
                                <li>
                                    <a href="detail.php">
                                        ...
                                        <div class="box_body">
                                            ...
                                            <p class="prices">12,000万円</p>
                                            <h4>東京都品川区北品川 5-11-20
                                                <span>JR山手線・埼京線・湘南新宿ライン「大崎」駅徒歩12分</span>
                                            </h4>
                                            <ul class="statistical">
                                                <li>2階</li>
                                                <li>48.24㎡</li>
                                ...
                                <li>
                                    <a href="detail.php">
                                        ...
                                        <div class="box_body">
                                            ...
                                            <p class="prices">12,000万円</p>
                                            <h4>東京都目黒区青葉台 1-22-10
                                                <span>東京メトロ日比谷線・東急東横線「中目黒」駅徒歩4分<br>
                                                東急東横線「代官山」駅徒歩10分</span>
                                            </h4>
                                            <ul class="statistical">
                                                <li>2階</li>
                                                <li>48.24㎡</li>
                                ...
                                <li>
                                    <a href="detail.php">
                                        ...
                                        <div class="box_body">
                                            ...
                                            <p class="prices">12,000万円</p>
                                            <h4>東京都文京区小石川 3-27-6
                                                <span>都営大江戸線・都営三田線「春日」駅徒歩5分<br>
                                                東京メトロ丸の内線・東京メトロ南北線「後楽園」駅徒歩6分</span>
                                            </h4>
                                            <ul class="statistical">
                                                <li>2階</li>
                                                <li>48.24㎡</li>
