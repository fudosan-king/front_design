                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <h2 class="title">恵比寿・目黒・白金エリア<span>の物件一覧</span></h2>
                            ...
                            <ul class="list_content list_content_property">
                                <li>
                                    <a href="detail.php">
                                        <div class="box_img">
                                            <img class="img-fluid" src="images/products/img06.jpg" alt="img06">
                                        </div>
                                        <div class="box_body">
                                            ...
                                            <p><span>2階</span> / <span>48.24㎡</span> / <span>１LDK</span> </p>
                                        </div>
                                    </a>
                                </li>
                                <li>
