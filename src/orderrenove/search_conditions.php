    ...
    <body>
        ...
        <footer>
            ...
            <div class="footer_bottom fixed-bottom">
                <a class="btn btn_conditions btn_search_conditions" target="_blank" href="https://www.logrenove.jp/contact"><img src="images/svg/i_search.svg" alt="" class="img-fluid" width="18">検索</a>
            </div>
        </footer>
