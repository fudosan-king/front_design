...
<head>
	<title>【公式】プレシス中野哲学堂パークフロント｜デザイン</title>
	<meta name="keywords" content="プレシス中野哲学堂パークフロント, 桜並木, 中野区, マンション, 新築, 株式会社プロスタイル"/>
	<meta name="description" content="眼下に桜並木と哲学堂公園の瑞々しい緑を臨むデザイン邸宅です。建物内モデルルーム公開中につき、実際の景色や日当たりもご体感いただけます。"/>
...
<body>
    <div id="page">
			...
			<section class="section_topbanner bg_topgallery">
	      			...
	      			<div class="container">
	      				<div class="row">
	      					<div class="col-12 text-center">
	      						<h2 class="headline mb-3">Gallery</h2>
				      			
				      			<div class="w_img_fullheight">
				      				<img src="images/gallery/entrance.jpg" alt="" class="img-fluid">
				      			</div>
				      			<p class="text_entrace">Entrance</p>

				      			<div class="m-auto w_img">
				      				<img src="images/gallery/livingroom.jpg" alt="" class="img-fluid">
				      			</div>
				      			<p class="text_entrace">Living room</p>

				      			<div class="row mt-md-5 mt-0">
				      				<div class="col-6 col-md-6">
				      					<div class="w_img">
						      				<img src="images/gallery/bathroom.jpg" alt="" class="img-fluid">
						      			</div>
						      			<p class="text_entrace">Bathroom</p>
				      				</div>
				      				<div class="col-6 col-md-6">
				      					<div class="w_img">
						      				<img src="images/gallery/powderroom.jpg" alt="" class="img-fluid">
						      			</div>
						      			<p class="text_entrace">Powder room</p>
				      				</div>
				      			</div>
