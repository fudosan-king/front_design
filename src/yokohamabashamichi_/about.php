				...
				<div class="row">
					<div class="col-12">
						...
						<div class="row">
							...
							<div class="col-12 col-md-6 align-self-center">
								<img src="assets/img/1x/img_map.jpg" alt="" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-12 col-md-4">
						<a class="box_logo" href="#">
							<img src="assets/img/1x/logo_chronicle.jpg" alt="" class="img-fluid">
							<p>株式会社クロニクル</p>
						</a>
					</div>
					<div class="col-12 col-md-4">
						<a class="box_logo" href="#">
							<img src="assets/img/1x/logo_chronicle_contrustion.jpg" alt="" class="img-fluid">
							<p>株式会社クロニクル建設</p>
						</a>
					</div>
					<div class="col-12 col-md-4">
						<a class="box_logo" href="#">
							<img src="assets/img/1x/logo_prostyle.jpg" alt="" class="img-fluid">
							<p>株式会社プロスタイル</p>
						</a>
					</div>
					<div class="col-12 col-md-4">
						<a class="box_logo" href="#">
							<img src="assets/img/1x/logo_chino.jpg" alt="" class="img-fluid">
							<p>千野建物管理株式会社</p>
						</a>
					</div>
					<div class="col-12 col-md-4">
						<a class="box_logo" href="#">
							<img src="assets/img/1x/logo_yantai.jpg" alt="" class="img-fluid">
							<p>煙台提案生活木業有限公司</p>
						</a>
					</div>
					<div class="col-12 col-md-4">
						<a class="box_logo" href="#">
							<img src="assets/img/1x/logo_propolifevn.jpg" alt="" class="img-fluid">
							<p>PROPOLIFE VIETNAM</p>
						</a>
					</div>
					<div class="col-12 col-md-4">
						<a class="box_logo" href="#">
							<img src="assets/img/1x/logo_kotakino.jpg" alt="" class="img-fluid">
							<p>株式会社小滝野</p>
						</a>
					</div>
					<div class="col-12 col-md-4">
						<a class="box_logo" href="#">
							<img src="assets/img/1x/logo_igeto.jpg" alt="" class="img-fluid">
							<p>株式会社沖縄イゲトー</p>
						</a>
					</div>
				</div>
