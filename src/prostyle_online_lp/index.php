                ...
                <div class="row">
                    <div class="col-12">
                        <div class="banner_content">
                            <h1>
                                <img src="images/SVG/banner_text_lg.svg" alt="" class="img-fluid d-none d-lg-inline-block" width="448">
                                <img src="images/SVG/banner_text_sm.svg" alt="" class="img-fluid d-block d-lg-none m-auto" width="300">
                            </h1>
                            ...
                            <div class="row no-gutters">
                                <div class="col-12 col-lg-4">
                                    <div class="box_onlineconsultation box_onlineconsultation_first">
                                        <img src="images/SVG/i_online.svg" alt="" class="img-fluid" width="120">
                                    ...
                                    <div class="row no-gutters flex-lg-row flex-column-reverse">
                                        <div class="col-12 col-lg-6">
                                            <div class="box_bg_hand text-center">
                                                <img src="images/1x/bg_hand.png" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-6">
                                            <div class="box_onlineconsultation mb-4 mb-lg-0">
                                                <img src="images/SVG/i_webcam.svg" alt="" class="img-fluid mb10" width="205">
                                                <h3>音声のみでの通話可能です</h3>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="wrap_main">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="box_recommended">
                                                ...
                                                時間の取れない方</span></h3>
                                                <div class="box_recommended_img">
                                                    <img src="images/SVG/family.svg" alt="" class="img-fluid" width="120">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <div class="box_recommended">
                                                ...
                                                お越し頂くのが難しい方</span></h3>
                                                <div class="box_recommended_img">
                                                    <img src="images/SVG/noun_Japan.svg" alt="" class="img-fluid" width="120">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="wrap_onlineconsultation_flow">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-4">
                                            <div class="box_onlineconsultation_flow">
                                                <div class="box_onlineconsultation_flow_img">
                                                    <img src="images/1x/schedule_adjustment.png" alt="" class="img-fluid" width="248">
                                                </div>
                                                <h3>日程調整</h3>
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="box_onlineconsultation_flow">
                                                <div class="box_onlineconsultation_flow_img">
                                                    <img src="images/1x/aboutusage.png" alt="" class="img-fluid" width="218">
                                                </div>
                                                <h3>利用方法について</h3>
                                                <p>メールでオンライン相談の詳細をお知らせいたします。<br>
                                                <span>（不明点がある場合は電話でサポートいたします）</span></p>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <div class="box_onlineconsultation_flow">
                                                <div class="box_onlineconsultation_flow_img">
                                                    <img src="images/1x/consultonline.png" alt="" class="img-fluid" width="236">
                                                </div>
                                                <h3>オンラインでご相談</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-3">
                                            <div class="box_caller">
                                                <img src="images/1x/caller.png" alt="" class="img-fluid" width="290">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h4>お気軽にご相談ください</h4>
                                <p class="mb-0 text-center"><a href="booking.php" class="btn btnBooking">オンライン相談のご予約</a></p>
                                <div class="box_example">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            ※スマートフォン1台で通話と資料閲覧を兼用することもできますが、画面が小さくなるため、文字が見えない等のご迷惑をおかけする可能性があります。</p>
                                            <h6>■所要時間</h6>
