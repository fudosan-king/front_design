...
"resource": {
  ...
  "rules":[
    [["if",0,1],["add",0,1,37,31]],
    [["if",1,2],["add",2]],
    [["if",1,3],["add",3,9,39,42,43],["block",2]],
    [["if",1,5],["add",4]],
    [["if",6,7],["add",4,43]],
    [["if",8,9],["add",5,43]],
    [["if",1,10],["add",6,40,43]],
    ...
    [["if",22,23],["add",11,43]],
    [["if",1,24],["add",12,43]],
    [["if",25,26],["add",12,41,43,40]],
    [["if",1,27],["add",13]],
    [["if",1,28],["add",13]],
    [["if",29,30],["add",14]],
    [["if",31],["add",15]],
    [["if",1,4],["add",16,18,19,44,47,50,51],["block",2]],
    [["if",1,33],["add",17,45,46,48,49],["block",47,50,51]],
    [["if",1,34],["add",17,45,46,48,49],["block",47,50,51]],
    ...
    [["if",1,58],["add",38]],
    [["if",1,59],["add",43]],
    [["if",1,32],["block",16,17,19,20,21,22,23,24,25,44]]]
},
"runtime":[]
...
var Ld=[C.B,C.J],Md=function(a){var b=a[C.Qd];b&&D(40);var c=a[C.Rd];c&&D(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Qd&&f!==C.Rd)if(-1<Ga(Ld,f)){var h=f,k=a[f],l=d[e];wd().set(h,k,l,"VN","VN-SG",c)}else{}},Nd=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
(void 0===G[a]||c&&!G[a])&&(G[a]=b);return G[a]},qn=function(a,b,c){return tf(a,b,void 0===c?!0:!!c)},rn=function(a,b,c){return 0===Ff(a,b,c)},sn=function(a,b){if(sh()){b&&J(b)}else jd(a,b)},tn=function(a){return!!Pl(a,"init",!1)},un=function(a){Nl(a,"init",!0)},vn=function(a){var b=Oe+"?id="+encodeURIComponent(a)+"&l=dataLayer";O(uh("https://","http://",b))},wn=function(a,b,c){Yi&&(rb(a)||aj(c,b,a))};
var xn=Pm.ph;function Un(a,b){a=String(a);b=String(b);var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c}var Vn=new Ka;function Wn(a,b,c){var d=c?"i":void 0;try{var e=String(b)+d,f=Vn.get(e);f||(f=new RegExp(b,d),Vn.set(e,f));return f.test(a)}catch(h){return!1}}
...
!0,void 0!==c.vtp_cookieUpdate&&(k=!!c.vtp_cookieUpdate));var l={prefix:f,path:d,domain:e,flags:h};c.vtp_enableCrossDomainFeature&&(c.vtp_enableCrossDomain&&!1===c.vtp_acceptIncoming||(c.vtp_enableCrossDomain||yg())&&Ug(a,l));Rg(l);Xg(["aw","dc"],l);b?kh(k,l):lh(k,l);var n=f;if(c.vtp_enableCrossDomainFeature&&c.vtp_enableCrossDomain&&c.vtp_linkerDomains){var q=c.vtp_linkerDomains.toString().replace(/\s+/g,"").split(",");Wg(a,q,c.vtp_urlPosition,!!c.vtp_formDecoration,n)}var p=nn(C.N);rk({od:!1,ma:void 0!=
p&&!1!==p,sc:l,zc:!0});c.vtp_enableUrlPassthroughFeature&&c.vtp_enableUrlPassthrough&&Zg(["aw","dc","gb"])});}();
...
0})(function(h){function k(B,F,E){return"DATA_LAYER"===B?nn(E):h[F]}function l(){v("gdpr_consent",mk()),v("gdpr",nk());}function n(){var B=[];return B}function q(B){var F=!0,E=[];if(B){E=n();}F&&b.push(r)}function p(){Gd()&&v("gcd","G1"+Kd(Dd));}ni();var r={google_basket_transaction_type:"purchase",google_conversion_domain:"",google_conversion_id:h.vtp_conversionId,google_conversion_label:h.vtp_conversionLabel,
google_conversion_value:h.vtp_conversionValue||0,google_remarketing_only:!1,onload_callback:h.vtp_gtmOnSuccess,gtm_onFailure:h.vtp_gtmOnFailure,google_gtm:Ij()};r.google_gtm_experiments={capi:!0};h.vtp_rdp&&(r.google_restricted_data_processing=!0);void 0!=nn(C.N)&&!1!==nn(C.N)&&(r.google_gtm_url_processor=function(B){return B=Ih(B)});var u=function(B){return function(F,E,H){var M=k(B,E,H);M&&(r[F]=M)}},
...
A?(h.vtp_conversionCookiePrefix&&(r.google_gcl_cookie_prefix=h.vtp_conversionCookiePrefix),r.google_read_gcl_cookie_opt_out=!1):r.google_read_gcl_cookie_opt_out=!0;"1"===rg(!1)._up&&v("gtm_up","1");l();(function(){var B=!1;!Fd()||B?q(!0):Qd(function(){l();var F=Od(C.B),E=void 0!=nn(C.N)&&!1!==nn(C.N),H=!1;
H=!0;h.vtp_transportUrl||F||!E&&!H||(r.google_transport_url="https://pagead2.googlesyndication.com/");v("gcs",Pd());p();q(F);F||Jd(function(){r=m(r);l();!h.vtp_transportUrl&&r.google_transport_url&&delete r.google_transport_url;v("gcs",Pd());p();v("gcu","1");q(!0)},C.B)},[C.B])})();a||(a=!0,O(y,f(),e(y)))})}();
...
h})};return{store:function(h,k){var l=f(h);l?l.button=k:e.push({form:h,button:k})},get:function(h){var k=f(h);return k?k.button:null}}}function d(e,f,h,k,l){var n=Pl("fsl",h?"nv.mwt":"mwt",0),q;q=h?Pl("fsl","nv.ids",[]):Pl("fsl","ids",[]);if(!q.length)return!0;var p=Ll(e,"gtm.formSubmit",q),r=e.action;r&&r.tagName&&(r=e.cloneNode(!1).action);p["gtm.elementUrl"]=r;l&&(p["gtm.formSubmitElement"]=l);if(k&&n){if(!on(p,Im(f),n))return!1}else on(p,function(){},n||2E3);return!0}(function(e){Z.__fsl=e;Z.__fsl.h=
"fsl";Z.__fsl.i=!0;Z.__fsl.priorityOverride=0})(function(e){var f=e.vtp_waitForTags,h=e.vtp_checkValidation,k=Number(e.vtp_waitForTagsTimeout);if(!k||0>=k)k=2E3;var l=e.vtp_uniqueTriggerId||"0";if(f){var n=function(p){return Math.max(k,p)};Ol("fsl","mwt",n,0);h||Ol("fsl","nv.mwt",n,0)}var q=function(p){p.push(l);return p};Ol("fsl","ids",q,[]);h||Ol("fsl","nv.ids",q,[]);tn("fsl")||(a(),un("fsl"));J(e.vtp_gtmOnSuccess)})}();
...
864E5);}google_tag_manager_external.postscribe.installPostscribe();Re=(new Date).getTime();}}
