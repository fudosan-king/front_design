        ...
        <main id="main">
            <section class="section_topbanner">
                <div class="topbanner_img">
                    <img src="images/KV.png" alt="" class="img-fluid main_bg d-none d-lg-block">
                    <img src="images/KV_sp.png" alt="" class="img-fluid main_bg d-block d-lg-none">
                    <div class="topbanner_content">
                        <p><img src="images/SVG/LogRenove_logo.svg" alt="" class="img-fluid" width="433"></p>
                        <h3>すべて自分たちの手に成る</h3>
            ...
            <section class="section_thoughts">
                <div class="container">
                    <div class="row">
            ...
            <section class="section_features">
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <div class="box_top_features">
                                <h3>LogRenoveの３つの特徴</h3>
                                <p>製材、流通、不動産仲介、設計、施工、アフターサービスまで、リノベーションの工程をすべて自社で行う「プライベートレーベル・リノベーション」と呼ぶスタイルがLogRenoveの「根幹」です。その幹から「３つの枝」が伸び、LogRenoveのサービスを形作っています。</p>
                            </div>
                            <article id="w_features01">
                                <div class="box_features_item">
                                ...
                                <div id="features01">
                                    <a href="#w_features01" class="btn btndetail" data-scroll><img src="images/SVG/arrow-down-circle.svg" alt="" class="img-fluid" width="20">詳細をみる</a>
                                    <div class="box_features_item_more">
                                        <p class="text-center mt-0"><a class="btn_up" href="#w_features01" data-scroll><img src="images/SVG/arrow-up-circle-black.svg" alt="" class="img-fluid" width="20"></a></p>
                                        <h2>【手軽・効率的】</h2>
                            ...
                            <article id="w_features02">
                                <div class="box_features_item">
                                    <div class="box_features_left">
                                        <p>FEATURES</p>
                                        <h1>02</h1>
                                        <p>自社製の無垢材による上質なデザイン。<br>
                                        確かな施工でサスティナブルな住まいを</p>
                                    </div>
                                    <div class="box_features_right">
                                        <div class="box_features_img">
                                ...
                                <div id="features02">
                                    <a href="#w_features02" class="btn btndetail" data-scroll><img src="images/SVG/arrow-down-circle.svg" alt="" class="img-fluid" width="20">詳細をみる</a>
                                    <div class="box_features_item_more">
                                        <p class="text-center mt-0"><a class="btn_up" href="#w_features02" data-scroll><img src="images/SVG/arrow-up-circle-black.svg" alt="" class="img-fluid" width="20"></a></p>
                                        <h2>【上質】</h2>
                            ...
                            <article id="w_features03">
                                ...
                                <div id="features03">
                                    <a href="#w_features03" class="btn btndetail" data-scroll><img src="images/SVG/arrow-down-circle.svg" alt="" class="img-fluid" width="20">詳細をみる</a>
                                    <div class="box_features_item_more">
                                        <p class="text-center mt-0"><a class="btn_up" href="#w_features03" data-scroll><img src="images/SVG/arrow-up-circle-black.svg" alt="" class="img-fluid" width="20"></a></p>
                                        <h2>【信頼】</h2>
             ...
             <section class="section_withoutwaste">
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <h4>理想のリノベーションをより多くの人にムリなくムダなく提供いたします。</h4>
                            <div class="withoutwaste_img">
                                <img src="images/without_waste.jpg" alt="" class="img-fluid w-100">
                            </div>
                            <p>プライベートレーベル・リノベーション</p>
