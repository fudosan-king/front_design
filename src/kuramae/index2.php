                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="living_img">
                                <img src="images/map_kuramae.png" data-aos="fade-up" data-aos-duration="3000" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row no-gutters">
                        <div class="col-12 col-lg-5">
                            <div class="design_img">
                                ...
                                <span class="design_text" data-aos="fade-up" data-aos-duration="3000">※1: 都営浅草線「蔵前」駅（A0出入口）徒歩5分、都営大江戸線「蔵前」駅（A6出入口）徒歩7分、都営大江戸線・つくばエクスプレス「新御徒町」駅（A4出入口）徒歩8分、東京メトロ銀座線「田原町」駅（エレベーター出入口）徒歩10分、都営浅草線「浅草橋」駅（A4出入口）徒歩11分、JR中央・総武線各駅停車「浅草橋」駅（東口）徒歩12分、都営浅草線「浅草」駅（A1出入口）徒歩14分、東京メトロ銀座線「稲荷町」駅（4出入口）徒歩14分</span>
                            </div>
                        </div>
                        <div class="col-12 col-lg-7">
                            <div class="design_content" data-aos="fade-down" data-aos-duration="3000">
                                <span class="img_artisanshipdesign"><img data-aos="fade-up-right" data-aos-duration="3000" src="images/artisanshipdesign.svg" alt="" class="img-fluid" width="360"></span>
                                <span class="img_building"><img data-aos="fade-up" data-aos-duration="3000" src="images/building.png" alt="" class="img-fluid"></span>
                                <ul class="list_global">
                                    <li><span>PROSTYLE</span></li>
                                    <li><span>KURAMAE</span></li>
                                    <li class="active"><span>STORY</span></li>
            ...
            <!-- <section class="section_location">
                ...
                <div class="box_contact">
                    ...
                    <div class="box_contact_content">
                        <h3>プロスタイル蔵前</h3>
                        <p><img src="images/i_location.svg" alt="" class="img-fluid" width="20"> 〒000-0000　東京都台東区三筋一丁目（地番）　　営業時間 10:00~19:00（⽕・⽔曜⽇定休 祝⽇を除く）</p>
                        <p><img src="images/i_tel.svg" alt="" class="img-fluid" width="20"> TEL : <a href="tel:03-6897-8570">03-6897-8570</a> 　FAX : <a href="tel:03-6897-8571">03-6897-8571</a></p>
                    </div>
                </div>
            </section> -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            ...
                            <div class="box_contact">
                                <div class="box_contact_img">
                                    <img src="images/img_contact2.png" alt="" class="img-fluid">
                                </div>
                                <div class="box_contact_content">
                                    <h3>●●●●●●●パンフレット進呈</h3>
