                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-lg-4 align-self-center">
                                                        <div class="box_img bg-transparent">
                                                            <img src="images/img_phone.png" alt="" class="img-fluid">
                                                            <span class="text-black">参考写真</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-lg-8 align-self-center">
                                                        <h3>会員登録制ポータルサイト・予約システム</h3>
                                                        <img src="images/logo_oicoo.png" alt="" class="img-fluid mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="carousel carousel_washroombathroom" data-flickity='{"prevNextButtons": false }'>
                                                <div class="carousel-cell">
                                                    <img src="images/img_washroombathroom01.jpg" alt="washroombathroom01" class="img-fluid">
                                                </div>
                                                <div class="carousel-cell">
                                                    <img src="images/img_washroombathroom02.jpg" alt="washroombathroom02" class="img-fluid">
                                                </div>
                                                <div class="carousel-cell">
                                                    <img src="images/img_washroombathroom03.jpg" alt="washroombathroom03" class="img-fluid">
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <ul class="list_products_security">
                                                <li>
                                                    <h6>開放感を感じる天井高</h6>
                                                    <div class="box_img custom">
                                                        <img src="images/ecosystem01.jpg" alt="ecosystem01" class="img-fluid">
                                                    </div>
                                                ...
                                                <li>
                                                    <h6>エコジョーズ</h6>
                                                    <div class="box_img custom">
                                                        <img src="images/ecosystem02.jpg" alt="ecosystem02" class="img-fluid">
                                                    </div>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="box_img custom">
                                                        <img src="images/ecosystem03.jpg" alt="ecosystem03" class="img-fluid">
                                                    </div>
                                                ...
                                                <li>
                                                    <h6>宅配ボックス</h6>
                                                    <div class="box_img custom">
                                                        <img src="images/ecosystem04.jpg" alt="ecosystem04" class="img-fluid">
                                                    </div>
                                                ...
                                                <li>
                                                    <h6>温水床暖房</h6>
                                                    <div class="box_img custom">
                                                        <img src="images/ecosystem05.jpg" alt="ecosystem05" class="img-fluid">
                                                    </div>
                                                ...
                                                <li>
                                                    <h6>天井埋込カセット形エアコン</h6>
                                                    <div class="box_img custom">
                                                        <img src="images/ecosystem06.jpg" alt="ecosystem06" class="img-fluid">
                                                    </div>
