                                ...
                                <div class="template_content">
                                    ...
                                    <div class="box_button">
                                        <div class="box_button_top">
                                            <a href="#" class="btn">サンプル表示</a>
                                            <a href="#modal_enlarged" class="btn" data-bs-toggle="modal">拡大・SP表示</a>
                                        </div>
                                        <div class="box_button_bottom">
                                            <a href="#" class="btn btn_makeit">これにする</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-lg-12">
                            <ul id="drag_template" class="template drag_template">
                                ...
                                <li>
                                    ...
                                    <div class="template_footer">
                                        <p>己紹介のお手本です。自己紹介のお手本です。自己紹介のお自手本です。自己紹介のお手本です。己紹介のお手本です。自己紹介のお手本です。自己紹介のお自手本です。自己紹介のお手本です。
                                            己紹介のお手本です。自己紹介のお手本です。
                                        </p>
                                        <a href="#" class="btn btn_edit">説明文Edit</a>
                                    </div>
                                </li>
