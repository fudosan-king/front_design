...
<div class="modal fade" id="modal_enlarged" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modal_enlarged">拡大・SP表示</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <img src="assets/images/PC.png" alt="PC" class="img-fluid">
                    </div>
                    <div class="col-12 col-lg-6">
                        <img src="assets/images/SP.png" alt="SP" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
