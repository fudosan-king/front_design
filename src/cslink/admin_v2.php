                        ...
                        <div class="col-12">
                            <div class="main_content template2">
                                ...
                                <div class="main_right template2 admin">
                                    ...
                                    <nav class="nav_addblock">
                                        <ul class="main_options">
                                            <li>
                                                <figure class="snip1467">
                                                    <img src="assets/images/options0.svg" alt="options" class="img-fluid">
                                                    <i class="ion-plus"></i>
                                                    <a id="options0" href="#"></a>
                                                </figure>
                                            </li>
                                            <li>
                                                <figure class="snip1467">
                                                    <img src="assets/images/options01.svg" alt="options" class="img-fluid">
                                                    <i class="ion-plus"></i>
                                                    <a id="options01" href="#"></a>
                                                </figure>
                                            </li>
                                            <li>
                                                <figure class="snip1467">
                                        ...
                                        <button type="button" class="btn btn_collapse">
                                            <img src="assets/images/chevron_right.svg" alt="chevron right" class="img-fluid" width="9">
                                        </button>
                                    </nav>
