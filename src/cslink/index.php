                            ...
                            <div class="main_left">
                                ...
                                <div id="box_detail" class="box_detail">
                                    <aside class="box_info">
                                        ...
                                        <ul class="info">
                                            <li><a href="tel:0368978580"><img src="assets/images/phone.svg" alt="phone"> 03-6897-8580</a></li>
                                            <li><a href="tel:08046225219"><img src="assets/images/smartphone.svg" alt="smartphone"> +81 080‐4622‐5219</a></li>
                                            <li><a href="mailto:saito-masayuki@propolife.co.jp"><img src="assets/images/mail.svg" alt="mail"> saito-masayuki@propolife.co.jp</a></li>
                                        </ul>
                                ...
                                <article class="standard_article" data-aos="fade-up">
                                    ...
                                    <div class="standard_img">
                                        <ul>
                                            <li>
                                                <p>資料名説明資料名説明</p>
                                                <a class="btn" href="#"><img src="assets/images/download.svg" alt="download" width="14"> Downlord</a>
                                            </li>
                                            <li>
                                                <p>資料名説明資料名説明資料名説明資料名<br>
                                                    説明資料名説明資料名説明</p>
                                                <a class="btn" href="#"><img src="assets/images/download.svg" alt="download" width="14"> Downlord</a>
                                            </li>
                                            <li>
