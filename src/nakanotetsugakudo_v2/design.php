...
<body>
    <div id="page">
			...
			<section class="section_topbanner bg_topdesign">
	      			...
	      			<div class="container">
	      				<div class="row">
	      					<div class="col-12 text-center">
	      						<h2 class="headline">The Residence</h2>
				      			...
				      			なお、植栽は特定の季節の状況を示すものではありません。又、植栽の樹種、大きさについては未確定となっており、竣工時には完成予想図程度には成長しておりません。</p>
	      					</div>
	      				</div>
	      			</div>
