...
<head>
	...
	<meta name="description" content="中野区松が丘2丁目の新築分譲マンションです。売主変更につき価格改定を実施しました。2DK〜3LDKを3,890万円から販売中です。全戸南東向き＋哲学堂公園ビュー。月々9万円台のお支払いで購入可。棟内モデルルーム公開中につき、実際のお部屋をご確認頂けます。"/>
...
<body>
    <div id="page">
			    ...
			    <div class="navbar navbar-expand-md bsnav bsnav-transparent">
			        ...
			        <div class="collapse navbar-collapse flex-row justify-content-end align-items-end">
			            <ul class="navbar-nav navbar-mobile mr-sm-4">
			                <li class="nav-item active"><a class="nav-link" href="index.php">Top</a></li>
			...
			<section class="section_topbanner">
				...
				<div class="owl-carousel owl-theme owl_topbanner">
				    <!-- <div class="item">
				    	<img class="d-none d-md-block img-fluid featured-image" src="images/1x/bg_top_pc.jpg">
				    	<img class="d-block d-md-none featured-image" src="images/1x/bg_top_sp.jpg">
				    </div> -->
				    <div class="item">
				    	<img class="d-none d-md-block img-fluid featured-image" src="images/1x/bg_top_pc2.jpg">
				    	<img class="d-block d-md-none img-fluid featured-image" src="images/1x/bg_top_sp2.jpg">
				    </div>
				</div>
			...
			<div class="w_topbanner_footer">
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							<!-- 2DK(39㎡超)3,890万円～月々9万円台～　3LDK(64㎡超)5,290万円～月々13万円台～ -->
							...
							<!-- <ul class="topbanner_footer">
								<li>
									<p>
										...
										<span class="price_yen">5,290</span><span class="label_yen">万円〜</span>
										<span class="monthly">月々</span> <span class="price_stand">13</span>
										<span class="label_stand">
											<span class="main_label_stand">万円</span>
											<span class="sub_label_stand">台<span class="last_text">〜</span></span>
										</span>
									</p>
								</li>
								<li>
	      	...
	      	<main>
	      		<section class="section_infomations">
	      			<div class="container">
	      				<div class="row">
	      					<div class="col-12">
	      						<ul class="list_info">
	      							...
	      							<li>
	      								<p>都心利便<span class="big_text">中野<span class="red">生活圏</span></span></p>
	      							</li>
	      							<li>
	      								<p>陽当たり良好<span class="big_text"><span class="whole_house">全邸</span><span class="red">南東</span>向き</span></p>
	      							</li>
	      							<li>
	      								<p>建物竣工済<span class="big_text red">即入居可</span></p>
	      							</li>
	      							<li>
	      							...
	      							<div class="row justify-content-center">
	      								<div class="col-12 col-sm-12 col-md-11">
	      									...
	      									<div class="w_btn_gradient">
      											<a href="reservation.php" class="btn btn_gradient btnReserve">
      												<p>Reserve</p>
      												<p>来場予約はこちら</p>
      											</a>
      											<a href="material.php" class="btn btn_gradient btnEntry">
      												<p>Entry</p>
      												<p>資料請求はこちら</p>
      											</a>
	      									</div>
  ...
  //   	var userAgent, ieReg, ie;
		...
		// if(ie) {
		//   $(".owl_topbanner .item").each(function () {
		//     var $container = $(this),
