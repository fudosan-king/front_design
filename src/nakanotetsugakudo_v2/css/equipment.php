					      						...
					      						<div class="box_equipment_item">
						      						...
						      						<h3>
							      						<div class="row">
							      							...
							      							<div class="col-6 align-self-center">
							      								<img src="images/1x/logo_misty.png" alt="" class="img-fluid logo_misty float-right">
							      							</div>
							      						</div>
						      						</h3>
					      						...
					      						<div class="box_equipment_item_special">
					      							<div class="row">
					      								...
					      								<div class="col-5 align-self-center">
					      									<h4>ぬるめ約39℃のお湯で、ぽっかぽか。酸素美泡湯で始める新入浴スタイル。</h4>
					      			...
					      			<div class="structure_item">
						      			<div class="row">
						      				<div class="col-12 col-md-5">
						      					<div class="row">
						      						<div class="col-6 col-md-12">
						      							<p>床スラブや妻壁、戸境壁は、コンクリート内に鉄筋を二重に組み上げるダブル配筋（一部ダブルチドリ配筋）とし、高い構造強度を発揮しました。階下への振動や床面の衝撃音を吸収するため、乾式置床と空気層を設けた床工法を採用し、床スラブ厚は約200mm（住戸部のみ）を確保。遮音性に配慮した床材を使用しました。外壁のコンクリート厚を約150〜約180mm（一部除く）確保し、耐久性・断熱性を向上。また、各住戸間を仕切る戸境壁を約180mmとし、隣接住戸の生活音にも配慮しました。</p>
						      						</div>
						      						<div class="col-6 col-md-12">
						      							<ul>
								      						<li>二重床二重天井構造</li>
						      					...
						      					<div class="row">
						      						<div class="col-6 col-md-12">
						      							<div class="structure_item_img">
						      								<a href="#"><img src="images/1x/structure02.png" alt="" class="img-fluid"></a>
						      							</div>
						      						</div>
						      						<div class="col-6 col-md-12">
						      							<h3>基礎構造</h3>
