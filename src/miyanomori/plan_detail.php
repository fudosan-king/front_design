                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-12 col-lg-6 align-self-center">
                                                <div class="box_infoview_img">
                                                    <img src="images/1x/view_inside02.png" alt="" class="img-fluid w-100">
                                                </div>
                                            </div>
                                        </div>
                                        <a href="#modal_video" data-toggle="modal" class="see_video">
                                            <img src="images/1x/3D_img.png" alt="" class="img-fluid" width="253">
                                        </a>
                                    </div>
                                </div>
                                <div class="box_plan_detail_img">
                                    <img src="images/1x/plan_detail.png" alt="" class="img-fluid">
                                </div>
                                ...
                                <div class="box_infoview_content">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-12 col-lg-7">
                                            <div class="box_infoview_img">
                                                <img src="images/1x/view_inside03.png" alt="" class="img-fluid w-100">
                                            </div>
                                        </div>
                                    </div>
                                </div>
