...
<body>
    <div id="page">
            ...
            <div class="navbar navbar-expand-lg ">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse menu-list">
                    <ul class="navbar-nav">
                        ...
                        <li class="active nav-item  js-menuAnimation"><a class="nav-link" href="https://www.prostyle-residence.com/sapporo/miyanomori/equipment/">設備仕様・構造</a></li>
        ...
        <section class="section_subbanner">
            <div class="subbanner_img bg_plan">
                <img src="images/new/B.jpg" alt="V" class="img-fluid w-100">
            </div>
                    ...
                    <div class="tab-pane fade show active" id="plandesign" role="tabpanel" aria-labelledby="plandesign-tab">
                        <div class="container">
                            <div class="equip-spec">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a rel="#first" class="nav-link" id=""><span>エレベーター</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a rel="#second" class="nav-link" id=""><span>フィットネスルーム</span></a>
                                    </li>
                                    <!-- <li class="nav-item" role="presentation">
                                        <a rel="#third" class="nav-link" id=""><span></span></a>
                                    </li> -->
                                    <li class="nav-item" role="presentation">
                                        <a rel="#fourth" class="nav-link" id=""><span>その他共用施設</span></a>
                                    </li>
                                </ul>
                            </div>

                            <!-- Section 1 -->
                                                    <div id="first" class="equip-spec_box inclined">
                                <h4><span>エレベーター</span></h4>
                                <p class="equip-spec_box-title">車椅子やベビーカーでも安心・快適に乗ることができるエレベーター</p>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <p class="equip-spec_box-des">車椅子やベビーカーでも安心・快適に乗ることができる斜行エレベーターを採用しています。窓からは、宮の森周辺の豊かな自然、札幌の美しい景観をどのシーズンも日々体感することができます。</p>
                                    </div>
                                </div>    
                            </div>

                            <!-- Section 2 -->
                                                    <div id="second" class="equip-spec_box inclined">
                                <h4><span>フィットネスルーム</span></h4>
                                <p class="equip-spec_box-title">日常に運動を取り入れることができるフィットネスルーム</p>
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="equip-spec_box_img">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <p class="equip-spec_box-des">ご入居者様専用のフィットネスルームがございます。日常に運動を取り入れることができ、体力づくりやリフレッシュを時間や天気を気にすることなくご自身のタイミングで楽しめます。</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Section 4 -->
                            <div id="fourth" class="equip-spec_box inclined more-row ">
                                <h4><span>その他共用施設</span></h4>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                        ...
                                        <p class="equip-spec_box-des p-right">本物件にはリモコン自動ゲート付きの自走式屋内平置き駐車場を採用しています。大切な愛車を守りながら気軽に車をご利用頂ける環境を整えております。</p>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="equip-spec_box_img">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                        <!-- <p class="equip-spec_box-des p-right">本物件にはリモコン自動ゲート付きの屋内平面駐車場を採用しています。天候の影響を受けにくく、北海道の積雪から大切な愛車を守ります。また、自動ゲートの設置によりセキュリティ面でも安心してご利用頂けます。</p> -->
                                        <p class="equip-spec_box-des">屋内駐車場の隣接に乾燥システムを備えたドライルームを設置しています。ウィンターシーズンにスキー・スノーボー ド等のウィンターアクテビティウエアや用品をここで一時保管し乾かすことができとても便利です。</p>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="equip-spec_box_img">
                                ...
                                <div class="row more-txt">
                                    <div class="col-md-4">
                                        <p class="equip-spec_box-title">トランクルーム</p>
                                        <p class="equip-spec_box-des">屋内駐車場の隣接には、普段ご利用しないものやオフシーズンのスタッドレスタイヤなどを大切に保管することができるトランクルームもございます。室内に持ち込まず保管できることで、ゆとりのある居住空間を確保することができます。</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Section 1 -->
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <p class="p-right">受付サービスから、宅配便・クリーニング・タクシーの取次サービス、重たくかさばる水、お米などの食材宅配受付、家事代行などの各種業者の紹介サービス、バーベキューセットや台車などの貸し出しなど。コンシェルジュが暮らしの要望にお応えします。</p>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="equip-spec_box_img">
                                            <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-1.jpg" class="img-fluid" alt="" tilte="" >
                                            <span>参考写真</span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="equip-spec_box_img">
                                            <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-2.jpg" class="img-fluid" alt="" tilte="" >
                                            <span>参考写真</span>
                                        </div>
                                    </div>
                                </div>  
                                <div class="equip-spec_ct">
                                    <div class="equip-spec_ct_box">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="equip-spec_box_img">
                                                    <img class="img-fluid" src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-3.jpg" alt="" title="">
                                                    <span>参考写真</span>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                ...
                                                <p class="equip-spec_ct_box-img">
                                                    <img class="img-fluid" src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-14.png" alt="" title="" >
                                                </p>
                                                <p>コンシェルジュの対応時間外は居住者様専用ポータルサイト「オイコス」をご利用いただけます。</p>
    <p>居住者様への様々なお知らせをサイト上やメールでも受信できるほか、管理規約などの書類の閲覧機能や 共用施設オンライン予約など、マンションライフに役立つメニューを揃えております。</p>
    <p>※ご利用には予め会員登録が必要となります。</p>
                                                <p class="equip-spec_ct_box-note"></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-6">
                                        <div class="equip-spec_box_img-alsok">
                                            <img alt="" title="" class="img-fluid" src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-4.jpg" >
                                        </div>
                                        綜合警備保障の〈ALSOK〉ガードセンターによる、24 時間集中監視システムを採用しました。住戸内で火災などの異常が発生した場合、住戸内のセキュリティインターホンが警報音を鳴らし、警報表示が点滅、さらに管理室にも警報が届きます。同時に綜合警備保障へ自動通報され、迅速かつ的確に対処。状況に応じて関係各所に通報します。<br />
    <br />
    ※機械警備は管理委託契約に則り、警備会社、警備システムが上記と異なる場合がございます。                                    <p class="equip-spec_ct_box-note"></p>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="equip-spec-box_img">
                                            <img alt="" title="" class="img-fluid" src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-5.jpg" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="equip-spec_box_items">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-6.png" alt="" title="">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <p class="equip-spec_box-title">防犯カメラ</p>
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-7.png" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <p class="equip-spec_box-title">カラーモニター付きインターホン</p>
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-8.png" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <p class="equip-spec_box-title">防犯センサー</p>
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-9.jpg" alt="" title="">
                                                <span>参考写真</span>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <p class="equip-spec_box-title">ダブルロック仕様ディンプルキー</p>
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-15.png" alt="" title="">
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <p class="equip-spec_box-title">鎌デッド錠</p>
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-11.png" alt="" title="">
                                                <span>参考写真</span>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <p class="equip-spec_box-title">防犯サムターン</p>
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-12.png" alt="" title="">
                                                <span>参考写真</span>
                                            </div>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <p class="equip-spec_box-des">エレベーター運転中に、地震管制装置が一定値を超えた地震の初期微動（P 波）・主要動（S波）を感知すると、最寄階に速やかに停止します。<br />
    また、停電した際には一旦停止後、停電時自動着床装置により、最寄階に自動停止し、さらに、天井の停電灯が点灯してエレベーター内を照らす他、インターホンが使用できるので、外部との連絡も可能です。<br />
    <br />
    ※エレベーター運転中に急速な大きい地震により、主要動（S 波）［高］を感知した場合は、その瞬間に直ちに休止し、最寄階への移動や扉が開かない場合がございます。<br />
    <br />
    ※非常用エレベーターは停電時、一旦停止後、非常用発電機が作動し通常の運転に戻ります。</p> 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="equip-spec_box_img">
                                                        <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-t-10.png" alt="" title="">
                                                        <span>参考写真</span>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="tab-pane fade" id="plandesign3" role="tabpanel" aria-labelledby="plandesign3-tab">
                        <div class="container">
                                ...
                                <div class="equip-spec_box_items">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-2.jpg" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-3.jpg" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-4.jpg" alt="" title="">
                                                <span>参考写真</span>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-5.jpg" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-6.jpg" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-7.jpg" alt="" title="">
                                                <span>参考写真</span>
                                            </div>
                            ...
                            <div id="洗面室・浴室" class="equip-spec_box">
                                ...
                                <div class="equip-spec_box_img custom slide-flickity">
                                ...
                                <div class="equip-spec_box_items">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-9.jpg" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-10.jpg" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                            <p class="equip-spec_box-des"></p>
                                        </div>

                                        <div class="col-md-4">
                                            <p class="equip-spec_box-title">ユーフォリア モノ ハンドシャワー</p>
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-11.jpg" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                            <p class="equip-spec_box-des"></p>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-12.jpg" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                            <p class="equip-spec_box-des"></p>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-13.jpg" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <p class="equip-spec_box-title">ボウル</p>
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-14.jpg" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                            <p class="equip-spec_box-des">※部屋タイプにより異なります。</p>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <p class="equip-spec_box-title">ボウル</p>
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-15.jpg" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                            <p class="equip-spec_box-des">※部屋タイプにより異なります。</p>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-16.jpg" alt="" title="">
                                                <span>参考写真</span>
                                            </div>
                                            <p class="equip-spec_box-des"></p>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-17.jpg" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                            <p class="equip-spec_box-des"></p>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="equip-spec_box_img">
                                                <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-th-18.jpg" alt="" title="">
                                                <span class="txt-black">参考写真</span>
                                            </div>
                                            <p class="equip-spec_box-des"></p>
                                        </div>
                            ...
                            <!-- Section 3 -->
                                ...
                                <p class="equip-spec_box-title">最高のくつろぎを生むプライベートサウナ</p>
                                <div class="row">
                                    <div class="col-md-4">
                                        <p class="p-right">全住戸にプライベートサウナを設置しており、心地よいサウナ浴をお楽しみ頂くことができます。日本で再び話題になっているサウナですが、発祥と言われる北欧のフィンランドでは、サウナで体の中から温めるのが病気の回復のもと、長寿の秘訣として2000年以上前から愛されてきました。現代では、60～80℃のマイルドな温熱空間にいると血流が通常時の2倍以上になり、酸素が体中をめぐり、筋肉の緊張がほぐれ、全身の細胞の代謝が高まり、発汗と共に体に溜まった乳酸や老廃物を出せることがわかっており、疲労回復、リラックス効果、美肌効果、快眠効果、痩せやすい体を作る効果などを得られると言われております。</p>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="plandesign4" role="tabpanel" aria-labelledby="plandesign4-tab">
                        <div class="container">
                            ...
                            <!-- Section 1 -->
                                ...
                                <h4><span>立面図</span></h4>
                                <div class="equip-spec_box_img">
                                    <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/equip-spec-f-1.jpg" alt="" title="">
                                </div>
                            </div>
                            ...
                            <!-- Section 2 -->
                                ...
                                <div class="floor-plans">
                                    <div class="ct-slider_item">
                                        <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/map-1.png" class="img-fluid" alt="" title="" >
                                        <img src="https://www.prostyle-residence.com/sapporo/miyanomori/wp-content/themes/miyanomori/assets/images/main/map-2.png" class="img-fluid" alt="" title="" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Section 3 -->
                                ...
                                <div class="col-md-12">
                                    ...
                                    <p class="equip-spec_box-des">住戸のある建物はコンクリートの耐久性を高めるため、柱・梁・床などの主要な構造部について、セメントの重量に対する水の重量の割合を最大値50.5%に設定しています。<br />
    ...
    ※住戸タイプにより異なります。詳細は図面集をご確認ください。</p>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <p class="equip-spec_box-des">住戸一部の開口部には、複数枚のガラスの間に空気層を設けた高断熱トリプルガラスを採用。高い断熱性を発揮し、冷暖房両方の負荷を軽減。省エネにも貢献します。<br />
    ※詳細は係員にお尋ねください。</p>
                                        </div>
                                        <div class="col-md-4">
