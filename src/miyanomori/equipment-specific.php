        ...
        <section class="section_subbanner slide-flickity">
            <div class="carousel" data-flickity data-flickity-options='{ "prevNextButtons": false }'>
                <div class="carousel-cell">
                    <img src="images/main/equipment-slide.jpg" alt="" title="">
                </div>
                <div class="carousel-cell">
                    <img src="images/main/equipment-slide.jpg" alt="" title="">
                </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-12">
                                    ...
                                    <div id="洗面室・浴室" class="equip-spec_box">
                                        ...
                                        <div class="equip-spec_box_img">
                                            <img src="images/img-full.jpg" alt="" title="">
                                            <span>参考写真</span>
                                        </div>
                                    ...
                                    <div class="equip-spec_box full-img">
                                        <div class="equip-spec_box_img">
                                            <img src="images/main/equip-spec-phone.jpg" alt="" title="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-12">
                                    ...
                                    <div id="物件概要" class="equip-spec_box">
                                        <h4>物件概要</h4>
                                        <div class="equip-spec_box_img">
                                            <img src="images/main/equip-spec-1.jpg" alt="" title="">
                                        </div>
                                    </div>
                                    <div id="専有部分" class="equip-spec_box">
                                        <h4>専有部分</h4>
                                        <div class="equip-spec_box_img">
                                            <img src="images/main/equip-spec-2.jpg" alt="" title="">
                                        </div>
                                    </div>
                                    <div id="共有部分" class="equip-spec_box">
                                        <h4>共有部分</h4>
                                        <div class="equip-spec_box_img">
                                            <img src="images/main/equip-spec-3.jpg" alt="" title="">
                                        </div>
                                    </div>
                                    <div id="仕上表" class="equip-spec_box">
                                        <h4>仕上表</h4>
                                        <div class="equip-spec_box_img">
                                            <img src="images/main/equip-spec-4.jpg" alt="" title="">
                                        </div>
                                    </div>
                                </div>
                            </div>
