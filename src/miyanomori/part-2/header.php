    ...
    <div class="navbar navbar-expand-lg bsnav bsnav-transparent bsnav-sticky bsnav-sticky-slide">
        ...
        <div class="collapse navbar-collapse justify-content-end">
            <ul class="navbar-nav navbar-mobile mr-0">
                <li class="nav-item js-menuAnimation hide-mobile"><a class="nav-link" href="#modal_login" data-toggle="modal">ログイン</a></li>
                <li class="nav-item js-menuAnimation dropdown dropdown-right hide-mobile ">
            ...
            <ul class="navbar-nav navbar-mobile mr-0 hide-pc show-mobile">
                <li class="nav-item js-menuAnimation"><a class="nav-link" href="#modal_login" data-toggle="modal">ログアウト</a></li>
            </ul>
