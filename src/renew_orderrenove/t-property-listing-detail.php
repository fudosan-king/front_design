    ...
    <body>
        ...
        <main>
                ...
                <section class="p-0 bg-white">
                    <div class="property-listing_detail">

                        <div class="listing-detail_swiper">
                            <div class="container">  
                                            ...
                                            <div class="property-archive_item">
                                                <a href="propertys_detail.php">
                                                    <div class="property_img">
                                                        <img src="images/property-listing/img-main.jpg" alt="" class="img-fluid">
                                    ...
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="detail-item_box">
                                                <div class="detail-item_thumnail">
                                                    <div class="detail-item_img">
                                                        <img src="images/property-listing/img.jpg" class="img-fluid" alt="" title="">
                                                    </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="detail-item_box">
                                                <div class="detail-item_thumnail">
                                                    <div class="detail-item_img">
                                                        <img src="images/property-listing/img1.jpg" class="img-fluid" alt="" title="">
                                                    </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="detail-item_box">
                                                <div class="detail-item_thumnail">
                                                    <div class="detail-item_img">
                                                        <img src="images/property-listing/img2.jpg" class="img-fluid" alt="" title="">
                                                    </div>
                                ...
                                <a href="#" class="btn btn-load-more">資料請求・内見</a>
                        ...
                        <div class="rnv-explain">
                            <div class="container">
                                <h2>スカイコート日本橋</h2>
                                <p>3路線、4駅利用可能という抜群の好立地に立つこのマンションは、その利便性にも関わらず、徒歩１分には浜町公園があるなど、緑に囲まれた落ち着いた環境にあります。コンビニはスーパーも徒歩圏内にあり、生活するにも便利です。</p>
                                <br>
                                <img class="img-fluid" src="./images/property-listing/GoogleStreetView.jpg" alt="" title="">
                        ...
                        <div class="detail-listing_relative">
                            <div class="container">
                                <h2>●●エリアの物件</h2>
