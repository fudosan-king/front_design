                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            ...
                            <div class="top_info">
                                <div class="top_brand">
                                    <img class="img-fluid" src="./images/common/logo-orderrenove.svg" alt="" title="">
                                </div>
                                <h3>提案型リノベーションプラットフォーム</h3>
                                <p>Order Renoveは「リノベーション済み物件」だけでなく、まだ施工していない「リノベーション向き物件」まで紹介していきます。まだ物件数が少ない「リノベーション済み物件」だけでなく、「中古物件＋リノベーション」を視野に入れることで、人々の住まいにおける選択肢を増やし、ユーザーに最適な住まいを提案していきます。</p>
                            </div>
                                            ...
                                            <div class="property_img">
                                                ...
                                                <div class="group_price">
                                                    ...
                                                    <div class="g-bg">
                                                        ...
                                                        <p class="total_price">5400<span class="unit">万円</span><span class="sub">（施工前価格）</span></p>
                                                    </div>
