            ...
            <div class="box_template">
                <section class="p-0">
                    <div class="box_top mb-0 bg-white">
                        <div class="container">
                            <h2 class="title mb-3 mt-4">希望に合った新着物件をお届け</h2>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-12">
                                <form action="" class="frm_search_conditions">
                                    <p class="mb-5">あなたのご希望条件にマッチした物件をメールでいち早くお知らせします。大手ポータルサイトに載っていない掘り出しものの物件もお届けしています。</p>

                                    <h2 class="little_title">名前 <span class="must">必須</span></h2>
                                    <div class="form-group">
                                        <input type="text" class="form-control">
                                    </div>

                                    <h2 class="little_title">電話番号 <span class="must">必須</span></h2>
                                    <div class="form-group">
                                        <input type="text" class="form-control">
                                    </div>
                                    ...
                                    <p>ご入力いただいた情報は、当社のプライバシーポリシーに従って厳重に管理いたします。下記の<a class="btn btn-link d-inline-block" href="#">プライバシーポリシー</a>を必ずご一読頂き、同意のうえお問い合わせください。</p>

                                    <div class="custom-control custom-checkbox my-3 text-center">
                                        <input type="checkbox" class="custom-control-input" id="ck_agree">
                                        <label class="custom-control-label" for="ck_agree">同意する</label>
                                    </div>

                                    <p class="text-center mb-0 mt-3"><button type="submit" class="btn btn_register">新規会員登録をして保存</button></p>
                                </form>
                            </div>
                        </div>
                    </div>
