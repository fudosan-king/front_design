            ...
            <div class="box_template bg-white">
                <section class="p-0">
                    <div class="box_top mb-0 bg-transparent">
                        <div class="container">
                            <h2 class="title mb-2 mt-4">リノベプラン問い合わせ完了</h2>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-lg-8 m-auto">
                                <p>お問い合わせいただき、ありがとうございますご入力いただいたメールアドレスに、プランの詳細資料をお送りいたしました。<br>後ほど、担当者よりご連絡申し上げます。<br>
                                ...
                                <p class="text-center mb-0 mt-5">
                                    ...
                                    <a href="#" class="btn d-inline-block">トップに戻る</a>
                                </p>
                            </div>
                        </div>
                    </div>
