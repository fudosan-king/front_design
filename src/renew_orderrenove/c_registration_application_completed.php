                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-lg-8 m-auto">
                                ...
                                <h5>送信先：<a href="mailto:info@thechill.jp">info@thechill.jp</a><br>
                                上記のメールアドレスに仮登録のご案内メールを送信いたしました。記載されているURLを24時間以内にクリックし、登録を完了してください。</h5>
                                <p>メールが届かない場合は、メールアドレスが間違っている可能性があります。お手数ですが、メールアドレスを確認の上、再度会員登録お願いいたします。</p>
                                <p>ドメイン指定受信をご利用の方は、order-renove.jpのドメインからのメールが受信できるよう設定変更をお願いします。</p>
                                <p class="text-center mb-0 mt-5">
                                    <a href="#" class="btn d-inline-block">OrderRenobeとは</a>
                                    <a href="#" class="btn d-inline-block mr-0">トップに戻る</a>
                                </p>
                            </div>
                        </div>
                    </div>
