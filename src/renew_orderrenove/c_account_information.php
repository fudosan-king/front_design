                        ...
                        <div class="row">
                            <div class="col-12 col-lg-12">
                                ...
                                <div class="box_accinfo">
                                    <div class="row no-gutters">
                                        <div class="col-12 col-lg-12 align-self-center">
                                            <a href="edit_account_information.php" class="btn btnedit mt-2">変更</a>
                                        </div>
                                ...
                                <div class="box_accinfo">
                                    <div class="row no-gutters">
                                        <div class="col-12 col-lg-12 align-self-center">
                                            <a href="member_register.php" class="btn btnedit mt-2">設定</a>
                                        </div>
                                        <div class="col-4 col-lg-4">
                                            <p class="head">エリア：</p>
                                        </div>
                                        <div class="col-8 col-lg-8">
                                            <p>千代田区, 中央区, 港区, 新宿区, 文京区, 台東区, 墨田区, 江東区, 品川区, 目黒区, 大田区, 世田谷区, 渋谷区, 中野区, 杉並区, 豊島区, 北区, 荒川区, 板橋区, 練馬区, 足立区, 葛飾区, 江戸川区, 横浜市中区</p>
                                        </div>
                                        <div class="col-4 col-lg-4">
                                            <p class="head">価格：</p>
                                        </div>
                                ...
                                <div class="box_accinfo">
                                    <div class="row no-gutters">
                                        <div class="col-12 col-lg-12 align-self-center">
                                            <a href="change_pass.php" class="btn btnedit mt-2">設定</a>
                                        </div>
                                        <div class="col-4 col-lg-4 align-self-center">
