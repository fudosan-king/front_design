            ...
            <div class="box_template bg-white">
                <section class="p-0">
                    <div class="box_top mb-0 bg-transparent">
                        <div class="container">
                            <h2 class="title mb-2 mt-4">物件問い合わせ完了</h2>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-lg-8 m-auto">
                                <p>お問い合わせいただき、ありがとうございますご入力いただいたメールアドレスに、お問い合わせ完了メールをお送りいたしました。<br>後ほど、（株）LogSuiteの担当者よりご連絡申し上げます。<br>
                                以下の「会員登録する」のボタンより、お問い合わせ時の入力内容にて会員登録が可能です。登録後は、お気に入り機能や新着メルマガなどの会員様向けのサービスをご利用いただけます。</p>
                                <p class="text-center mb-0 mt-5">
                                    <a href="#" class="btn d-inline-block">会員登録する</a>
