            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="aboutservices_top">
                        ...
                        <p>ログマンションは、リノベーション着工前にご契約いただければ、、お客様のご希望を活かした「カスタマイズ」をすることができます。<br>提示しているログマンションの販売価格内で、お客様のライフスタイルに合ったリノベーションを提案させていただけます。</p>
                    </div>
                    <ul class="box_aboutservices">
                        <li>
                            <div class="box_aboutservices_item">
                                ...
                                <h2><a href="#">理想の住まいを低コストで実現</a></h2>
                                <p class="description">カスタイマイズといえども、リノベーションの費用は全てログマンション販売価格内に含まれます。追加コストはありません。さらに、リノベーション工事完了後にお引渡しとなるのもポイント。中古物件を購入してリノベーションする場合、物件のお引渡し後にリノベーション工事を行うため、工事が完了するまでの間、 購入した物件の住宅ローン、管理費、修繕積立金などは、工事期間中もお客様負担となってしまいます。しかし、工事完了後のお引渡しになるログマンションの場合、そのコストをカットできるのです。</p>
                            </div>
                        </li>
                        <li>
                            <div class="box_aboutservices_item">
                                ...
                                <h2><a href="#">お客様ニーズをくみ取った設計、デザイン</a></h2>
                                <p class="description">理想の住まいを実現するためには設計、デザインがもっとも重要です。ログマンションのカスタマイズでは当社の経験豊富なプランナーが、お客様のニーズをじっくりお伺いして、カスタマイズプランを提案いたします。もちろん追加費用は頂きませんので、お気軽にご相談いただけます。</p>
                            </div>
                        </li>
                        <li>
                            <div class="box_aboutservices_item">
                                ...
                                <h2><a href="#">オリジナル家具、造作収納も用意</a></h2>
                                <p class="description">「趣味は映画鑑賞。大画面テレビの専用ボードをつくりたい」 「本をたくさん持っていて見せる収納をしたい」といったこだわりのニーズにこたえる、オリジナル家具、造作収納なども入居時にご用意可能。専属のインテリアコーディネーターとともに、理想のライフスタイルのイメージを膨らませてください。</p>
                            </div>
                        </li>
                    </ul>
                </div>
