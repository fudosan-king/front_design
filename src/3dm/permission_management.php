            ...
            <div class="row" id="body-row">
                ...
                <div class="col main_content">
                    <div class="main_header">
                        <h2 class="title"><img src="images/common/svg/i_permission.svg" alt="" class="img-fluid" width="25"><span>権限管理</span></h2>
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-link active" id="nav-itemlist-tab" data-toggle="tab" href="#nav-itemlist" role="tab" aria-controls="nav-itemlist" aria-selected="true">権限管理一覧</a>
                                    ...
                                    <div class="table-responsive">
                                        <table id="table_list" class="table table_list table_listitem table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td><p>アドミン</p></td>
                                                <td>
                                                    <p>ito-ryusuke@propolife.co.jp<br>
                                                    anh-n@propolife.co.jp</p>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td><p>セールス</p></td>
                                                <td>
                                                    <p>kimura-mamoru@propolife.co.jp</p>
                                                </td>
                                                <td>
                                                    <p>2021-07-20 08:37:34</p>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><p>インテリアコーディネーター</p></td>
                                                <td>
                                                    <p>kashiguchi-makiko@propolife.co.jp<br>
                                                    anh-n@propolife.co.jp</p>
                                                </td>
                                                <td>
                                                    <p>2021-07-20 08:37:34</p>
                        ...
                        <div class="modal-body">
                            <form action="" class="frm_user">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-12 col-lg-3 align-self-center">
                                            <label for="">権利設定</label>
                                        </div>
                                        <div class="col-12 col-lg-9 align-self-center">
                                            <div class="row">
                                                <div class="col-3 col-lg-3">
                                                    <p class="mb-0">アイテム編集　許可<br>
                                                    アイテム変種　拒否<br>
                                                    アイテム追加　見る</p>
                                                </div>
                                                <div class="col-9 col-lg-9">
                                                    <a href="#" class="btn btn_edit2">編集</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
