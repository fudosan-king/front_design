...
<section class="service-lp">
	<?php include './common/menu-logged.php' ?>
</section>
		...
		<div class="row">
			<div class="col-12 col-md-5 col-left">
				<div class="slide_text">
					...
					<p class="small-img"><img class="img-fluid" src="./images/parts/lp-text-slide.png" alt="" title=""></p>
					<p>素敵なお部屋作りをサポートいたします。<br>
					リノベーションやリフォームに興味を持って<br>
					いただけたらぜひご相談ください。</p>
					<p class="small-img hide-mobile"><img class="img-fluid" src="./images/parts/cirkle-slide-reception.png" alt="" title=""></p>
					<p class="slide_note">バーチャルリノベプランナー：<span>リノさん</span></p>
				</div>	
			</div>
			<div class="col-sm-12 col-md-7 col-right">
				<div class="slide_img">
					<img class="img-fluid" src="./images/parts/lp-pc-mb-slide.png" alt="" title="">
				</div>
			</div>
		</div>
		<div class="slide_reception">
			<div class="reception">
				<img class="hide-mobile img-fluid" src="./images/parts/lp-reception.png" alt="" title="">
				<img class="show-mobile hide-pc img-fluid" src="./images/parts/2x/lp-reception.png" alt="" title="">
			</div>	
		...
		<div class="row">
			<div class="col-md-6">
				<div class="about-lp_img">
					<img class="hide-mobile img-fluid" src="./images/parts/about-left.png" alt="" title="">
					<img class="hide-pc show-mobile img-fluid" src="./images/parts/2x/about-left.png" alt="" title="">
			    </div>	
			</div>
			<div class="col-md-6">
				<div class="about-lp_img">
					<img class="hide-mobile img-fluid" src="./images/parts/about-right.png" alt="" title="">
					<img class="hide-pc show-mobile img-fluid" src="./images/parts/2x/about-right.png" alt="" title="">
			    </div>	
			</div>
		</div>
...
<section id="operation-lp" class="service-lp operation-lp">
	<div class="container">
			...
			<div class="row">
				...
				<div class="col-12 col-auto">
					<div class="operation-lp_img">
						<img class="img-fluid" src="./images/parts/operation-1.png" alt="" title="">
					</div>
				</div>
		...
		<div class="step">
			<div class="row">
				<div class="col-12 col-md-3 width-step">
					<p class="btn btn-lp-sm-turquoise custom-w">｢アバター｣か、<span class="custom-span">｢映像｣を選ぶ</span>
						<span class="btn-lp-cirkle">2</span>
					</p>
				</div>
				<div class="col-auto">
					<div class="operation-lp_img">
						<img class="img-fluid" src="./images/parts/operation-2.png" alt="" title="">
					</div>
				</div>
				<div class="col-12 col-md-4 width-text">
		...
		<div class="step">
			<div class="row">
				...
				<div class="col-auto">
					<div class="operation-lp_img">
						<img class="img-fluid" src="./images/parts/operation-6.png" alt="" title="">
					</div>
				</div>
				<div class="col-12 col-md-4 width-text">
		...
		<div class="step">
			<div class="row">
				...
				<div class="col-auto">
					<div class="operation-lp_img">
						<img class="img-fluid" src="./images/parts/operation-3.png" alt="" title="">
					</div>
				</div>
				<div class="col-12 col-md-4 width-text">
					<p class="title">住まいのイメージがふくらむ</p>
		...
		<div class="row">
			<div class="col-12 col-md-5">
				<img src="./images/parts/operation-4.png" class="img-fluid" title="" alt="">
			</div>
			<div class="col-12 col-md-4 width-text">
			...
			<div class="col-12 col-md-3 width-img">
				<img src="./images/parts/operation-5.png" class="img-fluid" title="" alt="">
			</div>
		</div>
		...
		<div class="col-md-12 p-0">
			<div class="proposal-lp_box">
				<div class="proposal-lp_box_img">
					<img  class="hide-mobile img-fluid" src="./images/parts/proposal-1.png" alt="" title="" >
					<img class="show-mobile hide-pc img-fluid" src="./images/parts/2x/proposal-1.png" alt="" title="" >
					<img class="show-mobile hide-pc img-fluid" src="./images/parts/2x/proposal-2.png" alt="" title="" >
			...
			<div class="proposal-lp_box even-box">
				<div class="proposal-lp_box_img">
					<img  class="hide-mobile img-fluid" src="./images/parts/proposal-2.png" alt="" title="" >
					<img class="show-mobile hide-pc img-fluid" src="./images/parts/2x/proposal-3.png" alt="" title="" >
			...
			<div class="proposal-lp_box">
				<div class="proposal-lp_box_img">
					<img  class="hide-mobile img-fluid" src="./images/parts/proposal-3.png" alt="" title="" >
					<img class="show-mobile hide-pc img-fluid" src="./images/parts/2x/proposal-4.png" alt="" title="" >
					<img class="show-mobile hide-pc img-fluid" src="./images/parts/2x/proposal-5.png" alt="" title="" >
	...
	<div class="container">
		<div class="faq-top">
			...
			<div class="faq-lp_img">
				<img src="./images/parts/faq.png" class="img-fluid" alt="" title="" >
			</div>
		</div>
	</div>	
...
<?php include './common/after-logged-form.php' ?>
