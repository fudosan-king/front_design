                    ...
                    <div class="col-12 col-lg-4 align-self-center">
                        <div class="row no-gutters">
                                <div class="col-12 col-lg-6 align-self-center">
                                        <a href="#" class="box_download d-none d-lg-flex">
                                                <span>ダウンロード</span>
                        ...
                        <div class="container">
                                <div class="row">
                                        <div class="col-12 col-lg-12">
                                                <h2>ご入居申し込みに関する書類</h2>
                                                <div class="box_document_item">
                                                        <h4>東急リバブル管理物件申込書はこちらから</h4>
                                                        <ul>
                                                                <li><a href="#">ご入居申し込みに関する書類</a></li>
                                                                <li><a href="#">ご入居申し込みに関する書類</a></li>
                                                                <li><a href="#">ご入居申し込みに関する書類</a></li>
                                                        </ul>
                                                </div>
                                                <div class="box_document_item">
                                                        <h4>東急住宅リース管理物件申込書はこちらから</h4>
                                                        <ul>
                                                                <li><a href="#">ご入居申し込みに関する書類</a></li>
                                                                <li><a href="#">ご入居申し込みに関する書類</a></li>
                                                                <li><a href="#">ご入居申し込みに関する書類</a></li>
