...
<!--                     <li class="breadcrumb-item" aria-current="page"><a href="/property.php">投資物件情報一覧</a></li>
 -->                    <li class="breadcrumb-item active" aria-current="page">リマワル（第一号）</li>
        ...
        <div class="main_content">
            <div class="property_content signle-property">
                                            ...
                                            <div class="col-12 col-lg-8">
                                                <ul class="nav single-property_tabs" role="tablist">
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">ファンド情報</a>
                                                    </li>

                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">エリア情報</a>
                                                    </li>
                                                    ...
                                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                                        <div class="signle-property_ct">
                                                            <div class="signle-property_ct_des">
                                                                ...
                                                                <p>今回の商品の特徴としては当グループ会社にて家賃保証（マスターリース契約※裏面参照）での商品組成をしており、当社に万一が無い限り、商品利回りが確定している点が売りとなっております。投資初心者の方でも安心してご利用いただける商品となっております。</p>
                                                            </div>
                                                            <h3>募集要項</h3>
                                                            <div class="table">
                                                                <table class="table">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>5,000,000円  対象不動産の総額です<span class="small">（不動産鑑定評価額：5,000,000円）</span></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>募集総額<span class="light">（優先出資）</span></th>
                                                                            <td>4,000,000円 <span class="small">（1,000,000円は株式会社プロスタイルが出資いたします）</span></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>募集口数</th>
                                                                            <td>40口<span class="small">（募集口数に達しますと受付終了となります）</span></td>
                                                                        </tr>
                                                                        <tr>
                                                            ...
                                                            <div class="table">
                                                                <table class="table">
                                                                    <tbody>
                                                                        <tr>
                                                                            <th>契約先</th>
                                                                            <td>入居者様<span class="small">千野建物管理株式会社にてマスターリース契約）</span></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>契約期間</th>
                                                                            <td>令和4年11月26日<span class="small">（賃貸借契約）</span></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>契約賃料</th>
                                                                            <td>80,000円<span class="small">（賃料77,000円・管理費共益費3,000円）</span></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>
                                                            ...
                                                            <div class="bg-green-light">
                                                                ...
                                                                <div class="sidebar-right_info">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-9">
                                                                            <p class="number-big">125,000,000 <span class="unit">円</span></p>
                                                                            <p class="note-number-big">（※うち18,500,000円は弊社にて劣後出資）</p>
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <p class="sm-title">投資単位</p>
                                                                        </div>
                                                                        <div class="col-9">
                                                                            <p class="number-big">500,000<span class="unit">円／1口</span></p>
                                                                            <p class="note-number-big">（最低口数:1口／最大口数:5口）</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
