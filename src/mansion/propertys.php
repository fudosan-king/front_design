    ...
    <div class="box_template">
        <section class="section_near_property pt-0">
            ...
            <div class="container list_property">
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-12 m-10">
                        <div class="property bg-white">
                                            ...
                                            <div class="carousel carousel-nav"
                                                ...
                                                <div class="carousel-cell">
                                                    <div class="property_img">
                                                        <a href="propertys_detail.php"><img src="images/KV.jpg" alt=""
                                                                                            class="img-fluid"></a>
                                                        <p class="total_price">8,580<span>万円</span></p>
                                                ...
                                                <div class="carousel-cell">
                                                    <div class="property_img">
                                                        <a href="propertys_detail.php"><img src="images/KV.jpg" alt=""
                                                                                            class="img-fluid"></a>
                                                        <p class="total_price">11,470<span>万円</span><span class="sub">（物件＋リノベーション）</span>
                                                        </p>
                            ...
                            <div class="property-btn m-auto col-md-8 col-sm-8 col-8 text-center">
                                <a class="btn font-12">詳細情報を見る </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-12 m-10">
                        <div class="bg-white property">
                            <div class="carousel property_img"
                                 data-flickity='{ "fullscreen": true, "lazyLoad": 1 }'>
                                <div class="carousel-cell">
                                    <a href="propertys_detail.php">
