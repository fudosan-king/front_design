<!--footer.php # Footer HTML Part-->
<footer>
  <div class="container">
    <div class="block">
      <div class="block__link">
        <div class="block__link--item list1"> <a href="<?php echo home_url('/business/'); ?>"><b>事業紹介</b></a>
          <ul>
            <li><a href="<?php echo home_url('/business/mansionmanagement/'); ?>">分譲マンション管理事業</a></li>
            <li><a href="<?php echo home_url('/business/buildingmanagement/'); ?>">ビル・施設管理事業</a></li>
            <li><a href="<?php echo home_url('/business/brokerage/'); ?>">仲介事業</a></li>
            <li><a href="<?php echo home_url('/business/propertymanagement/'); ?>">プロパティマネジメント事業</a></li>
          </ul>
        </div>
        <div class="block__link--item list2"> <a href="<?php echo home_url('/livemansion/'); ?>"><b>管理マンションにお住まいの方</b></a>
          <ul>
            <li><a href="<?php echo home_url('/livemansion/service/'); ?>">ご入居中のお客様へのサービス・専有部サービスのご紹介</a></li>
            <li><a href="<?php echo home_url('/livemansion/investment/'); ?>">マンションを売りたい・貸したい</a></li>
          </ul>
        </div>
      </div>
      <div class="block__link">
        <div class="block__link--item list3"> <a href="<?php echo home_url('/findmansion/'); ?>"><b>マンション管理会社を探している</b></a>
          <ul>
