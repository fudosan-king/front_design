...
?>
        ...
        <main> <!-- InstanceBeginEditable name="content" -->
            ...
            <div id="kv-lower" class="investment">
                <div class="container">
                <div class="ttl">
                    <h2>マンションを売りたい・貸したい<span>I want to sell or rent my room</span></h2>
                </div>
                </div>
            </div>
            <!--lower visual HTML Part end-->
            <!--investment HTML Part-->
            <section id="page" class="livemansion">
                <div class="container">
                <section id="investment">
                    ...
                    <div class="column2">
                        ...
                        <div class="inner">
                            <h3>マンションを売りたい</h3>
                            <p>物件の売却を検討された際はご所有のマンションの管理を通じて物件の事を理解している当社へお任せください。不動産の売却方法には【仲介売却】【買取売却】と２通りあります。<br>
                            それぞの売却までの流れをはじめとして、メリット、デメリットがございますので、詳しくご紹介いたします。またどちらの方法がお客様の売却に適しているか、等もあわせてご相談を承りますので売却をご検討の際はお問い合わせください。</p>
                        </div>
                        </div>
                    </div>
                    <div class="column1 mt5">
                        ...
                        <table class="mt5">
                            <tr>
                            <td class="none"></td>
                            <th class="beside">メリット</th>
                            <th class="beside">デメリット</th>
                            </tr>
                            <tr>
                            <th class="ttl">仲介売却の場合</th>
                            　 <td class="sp_beside">メリット</td>
                            <td>一般的に買取よりも高額な売却が見込める</td>
                            <td class="sp_beside">デメリット</td>
                            <td>・売却までに時間がかかる<br>
                                ・売却時期、金額の見通しができず資金計画、引っ越し計画が立てられない<br>
                                ・売却していることを秘密にできない<br>
                                ・仲介手数料がかかる<br>
                                ・内見等の対応の必要がある<br>
                                ・瑕疵（かし）担保責任に問われる可能性がある</td>
                            </tr>
                            <tr>
                            <th class="ttl">買取売却の場合</th>
                                <td class="sp_beside">メリット</td>
                            <td>・売却金額に合意できれば売却までに時間がかからない<br>
                                ・金額に合意できれば、売却時期、金額が確定し、その後の計画が明確になる<br>
                                ・売却していることを秘密にできる<br>
                                ・仲介手数料が不要<br>
                                ・瑕疵（かし）担保責任を問われる可能性がない</td>
                                <td class="sp_beside">デメリット</td>
                            <td>売却金額が仲介より数十パーセント安くなる</td>
                            </tr>
                        </table>
                        <p class="small">※当社管理物件ご所有のお客様は仲介売却の際の仲介手数料は正規手数料より特別割引にて承っております。</p>
                        </div>
                    </div>
                    ...
                    <div class="column2">
                        ...
                        <div class="inner">
                            <h3>マンションを貸したい</h3>
                            <p>現在空室となっている、または今後引越す為にお部屋を貸したい方は、是非ご相談ください。当社はプロパティマネジメント業務を専門とする部署もあり、きめ細かなサービスや専門的なアドバイスが可能です。また、仲介事業を専門とする部署もあり、物件の利点を理解している当社においてしかできない仲介営業を行うことも可能です。</p>
                        </div>
                        </div>
                    </div>
                    <div class="mt5"> <a href="#" class="btn-brown">お問い合わせ</a> </div>
