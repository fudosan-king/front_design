...
?>
        ...
        <main> 
            ...
            <div class="recruit-psr_top">
                <section class="section_recruit-psr section_recruitmenttype">
                    <div class="container recruit-container">
                        <div class="row">
                            <div class="col-12 col-lg-12">
                                ...
                                <ul>
                                    <li>
                                        <a href="<?php echo home_url('/career-detail/'); ?>" class="box_recruitment">
                                            <div class="row g-0">
                                                ...
                                                <div class="col-12 col-lg-8 align-self-center">
                                                    <div class="recruitment_content">
                                                        <h3>仕入れ営業</h3>
                                                        <p>DEVELOPMENT</p>
                                                        <h4>ディベロップメント事業部　不動産「用地仕入れ営業」を募集！</h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-12 col-lg-8 align-self-center">
                                                    <div class="recruitment_content">
                                                        <h3>設計士</h3>
                                                        <p>ARCHITECT</p>
                                                        <h4>マンションから戸建まで多彩な経験を活かせる「設計士」募集！</h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                    ...
                    <div class="row g-0">
                        <div class="col-12 col-lg-6">
                            <a href="<?php echo home_url('/new-graduate/'); ?>" target="" class="box_career">
                                ...
                                <img src="<?php bloginfo('template_directory');?>/assets/images/common/新卒下段バナー.jpeg" alt="新卒下段バナー"
                                    class="img-fluid">
                                <span>
                                    <h3>新卒採用</h3>
                                    <p>NEW GRADUATE</p>
                        ...
                        <div class="col-12 col-lg-6">
                            <a href="<?php echo home_url('/career/'); ?>" target="" class="box_career">
                                ...
                                <img src="<?php bloginfo('template_directory');?>/assets/images/common/中途バナー小.jpeg" alt="中途バナー小"
                                    class="img-fluid">
