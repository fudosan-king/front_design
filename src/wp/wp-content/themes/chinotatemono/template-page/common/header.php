<header>
  <div class="block">
    <div class="block__ttl">
      <h1><a href="<?php echo home_url('/'); ?>"><img src="<?php bloginfo('template_directory');?>/assets/img/logo_chinotatemono.svg" alt="千野建物管理株式会社"></a></h1>
    </div>
    <div class="block__navi"><a href="" class="btn-cv">お問い合わせ</a>
      <nav class="">
        <ul class="mega_menu">
          <li><a href="<?php echo home_url('/'); ?>">TOP</a></li>
          <li class="menu"><a href="<?php echo home_url('/company/'); ?>">企業情報</a>
            <ul class="child_menu">
              <li class="ttl"><b>企業情報</b><span>company</span></li>
              <li class="link"><a href="<?php echo home_url('/company/profile/'); ?>"><img src="<?php bloginfo('template_directory');?>/assets/img/navi_img_1.jpg" alt=""><span>会社概要</span></a></li>
              <li class="link"><a href="<?php echo home_url('/company/philosophy/'); ?>"><img src="<?php bloginfo('template_directory');?>/assets/img/navi_img_2.jpg" alt=""><span>企業理念</span></a></li>
              <li class="link"><a href="<?php echo home_url('/company/group/'); ?>"><img src="<?php bloginfo('template_directory');?>/assets/img/navi_img_3.jpg" alt=""><span>グループ会社一覧</span></a></li>
              <li class="link"><a href="<?php echo home_url('/company/history/'); ?>"><img src="<?php bloginfo('template_directory');?>/assets/img/navi_img_4.jpg" alt=""><span>沿革</span></a></li>
            </ul>
          </li>
          ...
          <li class="menu"><a href="<?php echo home_url('/livemansion/'); ?>">管理マンションにお住まいの方</a>
            <ul class="child_menu">
              ...
              <li class="link lg"><a href="<?php echo home_url('/livemansion/service/'); ?>"><img src="<?php bloginfo('template_directory');?>/assets/img/navi_img_9.jpg" alt=""><span>ご入居中のお客様へのサービス/専有部サービスのご紹介</span></a></li>
              <li class="link lg"><a href="<?php echo home_url('/livemansion/investment/'); ?>"><img src="<?php bloginfo('template_directory');?>/assets/img/navi_img_10.jpg" alt=""><span>マンションを売りたい・<br>
                貸したい</span></a></li>
            </ul>
          </li>
          ...
          <li class="menu"><a href="<?php echo home_url('/rentalowner/'); ?>">賃貸物件のオーナー様</a>
            <ul class="child_menu">
