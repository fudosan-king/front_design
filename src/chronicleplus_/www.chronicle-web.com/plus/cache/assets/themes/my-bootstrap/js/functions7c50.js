jQuery(function($) {
    ...
    $('#185822_4716pi_185822_4716_21688').change(function(){
        if(this.checked){
            $('.frm_contact_content.date').fadeIn('slow');

            $('#185822_4716pi_185822_4716_21688').val('true');
        }
        else{
            $('.frm_contact_content.date').fadeOut('slow');
            $('#185822_4724pi_185822_4724').closest('.form-group').find('.errorDisplay').html('').fadeOut();

            $('#185822_4716pi_185822_4716_21688').val('false');
        }
    });

    if($("#185822_4716pi_185822_4716_21688").is(':checked')) {
        $(".frm_contact_content.date").fadeIn();  // checked
        $(this).parent().parent().parent().parent().addClass('bg_active');
        $('#185822_4716pi_185822_4716_21688').val('true');
    }
    else {
        $(".frm_contact_content.date").fadeOut();  // unchecked
        $('#185822_4724pi_185822_4724').closest('.form-group').find('.errorDisplay').html('').fadeOut();
         $('#185822_4716pi_185822_4716_21688').val('false');
    }

    $('#185822_4714pi_185822_4714_21686').change(function(){
        if(this.checked){

            $('#185822_4714pi_185822_4714_21686').val('true');
        }
        else{

            $('#185822_4714pi_185822_4714_21686').val('false');
        }
    });
    ...
    //Kyoto
    $('.show_listCity_kyoto').click(function(event) {
        event.preventDefault();
        $('.area_Kansai, .area_kansai_xs, .searchBy_status_kansai').hide('slow/400/fast', function() {});
        $('#sectionKansai .box_option_kyoto').show('slow/400/fast', function() {});
    });
    $('.btn_back_kyoto').click(function(event) {
        event.preventDefault();
        $('.area_Kansai, .area_kansai_xs, .searchBy_status_kansai').show('slow/400/fast', function() {});
        $('#sectionKansai .box_option_kyoto').hide('slow/400/fast', function() {});
    });
    $('.btn_accordion_kyoto').click(function(event) {
        event.preventDefault();
        $('#sectionKansai .box_option, #sectionKansai .box_accordion').hide('slow/400/fast', function() {});
        $('#sectionKansai .box_accordion_kyoto').show('slow/400/fast', function() {});
    });
    

    //shiga
    $('.show_listCity_shiga').click(function(event) {
        event.preventDefault();
        $('.area_Kansai, .area_kansai_xs, .searchBy_status_kansai').hide('slow/400/fast', function() {});
        $('#sectionKansai .box_option_shiga').show('slow/400/fast', function() {});
    });
    $('.btn_back_shiga').click(function(event) {
        event.preventDefault();
        $('.area_Kansai, .area_kansai_xs, .searchBy_status_kansai').show('slow/400/fast', function() {});
        $('#sectionKansai .box_option_shiga').hide('slow/400/fast', function() {});
    });
    $('.btn_accordion_shiga').click(function(event) {
        event.preventDefault();
        $('#sectionKansai .box_option, #sectionKansai .box_accordion').hide('slow/400/fast', function() {});
        $('#sectionKansai .box_accordion_shiga').show('slow/400/fast', function() {});
    });
    ...
    $("input[name='line']" ).click(function() {
        $('.btn_SearchStation').css('display', 'inline-block');
        $('.bottom_searchCondition .btn_specifyConditions').css('display', 'inline-block');

        _u = navigator.userAgent.toUpperCase();
        _isMobile = -1 !== _u.indexOf("IPHONE") || -1 !== _u.indexOf("ANDROID") && -1 !== _u.indexOf("MOBILE");
        console.log(_isMobile);
        if ( _isMobile){
            $('.btn_SearchStation').css({'width': '49%', 'margin-top': 'initial'});
            $('.bottom_searchCondition .btn_specifyConditions').css({'width': '49%', 'padding': '15px 0', 'font-size': '16px'});
            $('.bottom_searchCondition .btn_specifyConditions .i_specifyConditions').remove();
        }
    ...
    $('#185822_4724pi_185822_4724').datetimepicker({
        timepicker: false,
        format: "Y/m/d",
    });
    ...
    $('#185822_4676pi_185822_4676').datetimepicker({
        datepicker: false,
        format: "H:00",
        allowTimes: arrTime
    });
